/*  TidelibBolinasBolinasLagoonCalifornia.cpp 
...
#include "TidelibBolinasBolinasLagoonCalifornia.h"
...
// Selected station: Bolinas, Bolinas Lagoon, California
char stationID[] = "Bolinas, Bolinas Lagoon, California";
// Selection station ID number: 9414958
const long stationIDnumber = 9414958;
...
const float Datum = 2.3228 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.03,0.945,0.121,0.062,0.01,1.319,0.02,0.072,0.023,0.007,0.249,0.049,0.518,0.03,0.262,0.089,0.026,0.016,0.013,0.285,0.007,0,0.026,0.023,0.052,0.062,0.033,0.075,0.079,0.026,0.043,0.01,0,0,0,0.2,0.102};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {288.4,240.4,202.1,216.4,256.8,215.2,304.3,355.4,30.2,137.1,190.6,129.8,228.6,288.3,239.9,241.5,251.7,262,30.6,228.4,28.7,0,234.4,177.1,31,183.2,218.8,353.3,350.9,347,17.5,31.9,0,0,0,217.7,285.3};
