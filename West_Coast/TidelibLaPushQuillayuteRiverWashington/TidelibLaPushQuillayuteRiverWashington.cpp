/*  TidelibLaPushQuillayuteRiverWashington.cpp 
...
#include "TidelibLaPushQuillayuteRiverWashington.h"
...
// Selected station: La Push, Quillayute River, Washington
char stationID[] = "La Push, Quillayute River, Washington";
// Selection station ID number: 9442396
const long stationIDnumber = 9442396;
...
const float Datum = 4.57 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.089,1.411,0.236,0.066,0.052,3.061,0.003,0.003,0.003,0,0.64,0.072,0.86,0.049,0.44,0.151,0.016,0.01,0.023,0.873,0.003,0,0.049,0.016,0.069,0.128,0.026,0.003,0,0.003,0.003,0.003,0,0,0,0.561,0.052};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {252.8,239.6,254.4,258.6,244.1,234.9,293,95.5,80.5,0,210.2,183.4,223.8,266.3,235.8,216,205.4,258.4,346.6,262,43.6,0,257.4,260.2,184.9,213.3,209.7,20.8,0,54.1,40.2,66.9,0,0,0,286.5,125.8};
