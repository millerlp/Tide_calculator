...
#include "TidelibEverettWashington.h"
...
// Selected station: Everett, Washington
char stationID[] = "Everett, Washington";
// Selection station ID number: 9447659
const long stationIDnumber = 9447659;
...
const float Datum = 6.48 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.121,2.654,0.23,0.092,0.108,3.31,0,0.062,0.039,0.003,0.614,0.079,1.532,0.066,0.876,0.295,0.039,0.007,0,0.846,0.003,0.003,0.049,0.023,0.079,0.118,0.059,0,0,0,0,0,0.072,0,0,0.253,0.108};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {286.1,276.9,39.2,38.1,267.7,11.6,0,181.5,327.2,244.1,345.3,319,258.3,295.4,275.4,249.1,240,38.1,0,37.1,294.8,36.9,36.1,23.4,346.1,348.8,250.4,0,0,0,0,0,140.5,0,0,292.9,231.1};
