/*  TidelibOaklandInnerHarborSanFranciscoBayCalifornia.cpp 
...
#include "TidelibOaklandInnerHarborSanFranciscoBayCalifornia.h"
...
// Selected station: Oakland Inner Harbor, San Francisco Bay, California
char stationID[] = "Oakland Inner Harbor, San Francisco Bay, California";
// Selection station ID number: 9414764
const long stationIDnumber = 9414764;
...
const float Datum = 3.3268 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.057,1.254,0.143,0.058,0.05,2.079,0,0.074,0.016,0.001,0.452,0.06,0.722,0.031,0.415,0.14,0.02,0.003,0,0.528,0.004,0.004,0.032,0.014,0.05,0.088,0.027,0,0,0,0,0,0.043,0,0,0.105,0.121};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {239,231.2,229.6,244.6,223.3,221,0,130,79.9,135.3,197.2,173.4,215.4,246.9,230,207.5,199.7,229.3,0,228.9,265.2,297.6,228.6,224.7,213.1,200.4,208.5,0,0,0,0,0,147.5,0,0,227.8,288.3};
