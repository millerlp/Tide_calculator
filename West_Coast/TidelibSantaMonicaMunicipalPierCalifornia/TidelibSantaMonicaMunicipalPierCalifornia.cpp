/*  TidelibSantaMonicaMunicipalPierCalifornia.cpp 
...
#include "TidelibSantaMonicaMunicipalPierCalifornia.h"
...
// Selected station: Santa Monica, Municipal Pier, California
char stationID[] = "Santa Monica, Municipal Pier, California";
// Selection station ID number: 9410840
const long stationIDnumber = 9410840;
...
const float Datum = 2.7854 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.066,1.115,0.19,0.016,0.036,1.66,0.01,0,0,0,0.394,0.049,0.715,0.033,0.351,0.131,0.016,0.007,0.013,0.656,0,0,0.043,0.013,0.052,0.075,0.023,0,0,0,0,0,0,0,0,0.213,0};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {222.3,209.1,136.6,162.9,216.7,147.3,345.4,0,0,0,125.5,97.9,193.8,236.8,205.1,185.8,187.1,143,291.6,143.2,0,0,128,145.5,88.7,131.3,188.4,0,0,0,0,0,0,0,0,183.2,0};
