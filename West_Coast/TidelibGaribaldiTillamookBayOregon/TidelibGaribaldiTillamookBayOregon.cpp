/*  TidelibGaribaldiTillamookBayOregon.cpp 
...
#include "TidelibGaribaldiTillamookBayOregon.h"
...
// Selected station: Garibaldi, Tillamook Bay, Oregon
char stationID[] = "Garibaldi, Tillamook Bay, Oregon";
// Selection station ID number: 9437540
const long stationIDnumber = 9437540;
...
const float Datum = 4.4882 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.069,1.371,0.197,0.085,0.046,2.877,0.007,0.095,0.052,0.007,0.584,0.062,0.83,0.043,0.423,0.141,0.016,0.007,0.039,0.771,0.007,0,0.049,0.033,0.046,0.121,0.03,0.039,0.013,0.039,0.059,0.013,0.085,0,0,0.364,0.046};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {266.3,245.8,265.5,241.4,272.7,242.6,227.9,250.4,358.5,15.9,220,195.3,229.1,285,242.1,223.6,226.9,184.9,7.7,273,354.4,0,266.1,223,252,221.8,217.1,247.6,308.6,229.9,286.6,72.4,183.4,0,0,286.2,198};
