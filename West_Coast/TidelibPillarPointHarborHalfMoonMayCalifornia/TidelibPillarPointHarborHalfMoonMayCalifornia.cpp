/*  TidelibPillarPointHarborHalfMoonMayCalifornia.cpp 
...
#include "TidelibPillarPointHarborHalfMoonMayCalifornia.h"
...
// Selected station: Pillar Point Harbor, Half Moon May, California
char stationID[] = "Pillar Point Harbor, Half Moon May, California";
// Selection station ID number: 9414131
const long stationIDnumber = 9414131;
...
const float Datum = 2.9888 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.059,1.151,0.129,0.049,0.052,1.78,0,0.006,0.003,0.004,0.39,0.052,0.738,0.033,0.382,0.143,0.02,0.003,0,0.473,0.003,0.006,0.028,0.013,0.043,0.077,0.03,0,0,0,0,0,0,0,0,0.125,0.128};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {224.3,217.3,190,209.8,210.4,184.1,0,283,351.3,323.7,158.4,132.6,203.3,231.4,216.3,196.3,189.3,189.8,0,189.6,253.9,107.8,189.3,186.7,178.7,161.9,197.2,0,0,0,0,0,0,0,0,221.4,286.9};
