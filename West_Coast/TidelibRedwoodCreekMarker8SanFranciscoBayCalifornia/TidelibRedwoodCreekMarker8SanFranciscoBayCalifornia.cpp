/*  TidelibRedwoodCreekMarker8SanFranciscoBayCalifornia.cpp 
...
#include "TidelibRedwoodCreekMarker8SanFranciscoBayCalifornia.h"
...
// Selected station: Redwood Creek Marker 8, San Francisco Bay, California
char stationID[] = "Redwood Creek Marker 8, San Francisco Bay, California";
// Selection station ID number: 9414501
const long stationIDnumber = 9414501;
...
const float Datum = 4.25 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.059,1.362,0.197,0.177,0.049,2.858,0.03,0.036,0.036,0.013,0.587,0.043,0.814,0.043,0.42,0.151,0.016,0.007,0.046,0.627,0,0,0.039,0.062,0.069,0.125,0.033,0.095,0.128,0.016,0.03,0.03,0,0,0,0.125,0.128};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {282.5,240.9,238.1,229.5,268.3,241.7,3.8,2.1,55.3,119.2,219.8,208.2,225.1,279.2,237.4,225.9,214.8,260.6,222.6,259.8,0,0,234,216,11,227.5,195.3,93,77.5,13,7.1,47.4,0,0,0,221.4,286.9};
