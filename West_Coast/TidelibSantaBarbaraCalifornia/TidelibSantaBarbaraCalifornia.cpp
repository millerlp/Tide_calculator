/*  TidelibSantaBarbaraCalifornia.cpp 
...
#include "TidelibSantaBarbaraCalifornia.h"
...
// Selected station: Santa Barbara, California
char stationID[] = "Santa Barbara, California";
// Selection station ID number: 9411340
const long stationIDnumber = 9411340;
...
const float Datum = 2.79 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.069,1.161,0.167,0.02,0.039,1.634,0.01,0.007,0,0.003,0.384,0.049,0.735,0.036,0.367,0.135,0.013,0.007,0.023,0.581,0.003,0.003,0.033,0.007,0.049,0.072,0.026,0.003,0.003,0.003,0.003,0.007,0.02,0,0,0.239,0};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {226.2,212.4,143.1,167.2,220.7,156.4,1.8,288.8,0,295,133.2,104.2,197.2,241.2,207.5,189.4,185.6,113.3,307.9,150.8,286.2,73.5,139.5,177.7,94.8,140.1,189.1,246.2,146.8,239.9,292,336.3,158.4,0,0,176,0};
