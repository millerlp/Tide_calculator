/*  TidelibCoyoteCreekAlvisoSloughSanFranciscoBayCalifornia.cpp 
...
#include "TidelibCoyoteCreekAlvisoSloughSanFranciscoBayCalifornia.h"
...
// Selected station: Coyote Creek, Alviso Slough, San Francisco Bay, California
char stationID[] = "Coyote Creek, Alviso Slough, San Francisco Bay, California";
// Selection station ID number: 9414575
const long stationIDnumber = 9414575;
...
const float Datum = 4.87 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.059,1.302,0.22,0.217,0.059,3.127,0.036,0.161,0.069,0.02,0.627,0.059,0.738,0.036,0.4,0.135,0.013,0.03,0.102,0.699,0.01,0.003,0.039,0.082,0.128,0.151,0.026,0.095,0.161,0.072,0.092,0.036,0,0,0,0.144,0.098};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {300.3,246.9,254.3,241.2,283.5,250.1,146.7,1.6,44.1,96.2,232.7,220.2,232.8,307.7,246.1,235.1,246.5,43.9,214.9,273.8,96.4,322.6,229,224.2,357.2,227.1,227,66.8,68,342.8,24.3,68.9,0,0,0,200.2,272.3};
