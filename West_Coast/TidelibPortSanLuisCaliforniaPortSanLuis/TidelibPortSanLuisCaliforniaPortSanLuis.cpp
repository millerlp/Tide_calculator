/*  TidelibPortSanLuisCaliforniaPortSanLuis.cpp 
...
#include "TidelibPortSanLuisCaliforniaPortSanLuis.h"
...
// Selected station: Port San Luis, California
char stationID[] = "Port San Luis, California";
// Selection station ID number: 9412110
const long stationIDnumber = 9412110;
...
const float Datum = 2.8 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.072,1.188,0.144,0.039,0.046,1.644,0,0,0,0,0.384,0.046,0.745,0.039,0.377,0.135,0.013,0.003,0.02,0.492,0,0,0.03,0.01,0.049,0.072,0.03,0,0,0,0,0,0.02,0,0,0.184,0.105};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {225.6,214.7,156.1,187.2,222.2,168.1,0,0,0,0,144,114.6,198.8,242.2,211.9,190.7,186.5,163.6,315.5,163.7,0,0,151.7,188.1,103.1,150.2,194.8,0,0,0,0,0,123.7,0,0,191.9,279.1};
