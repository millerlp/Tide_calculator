/*  TidelibLaJollaScrippsInstitutionWharfCalifornia.h 
  A library for calculating the current tide height at 
   La Jolla (Scripps Institution Wharf), California , NOAA station ID number  9410230 
...
#ifndef  TidelibLaJollaScrippsInstitutionWharfCalifornia_h 
#define  TidelibLaJollaScrippsInstitutionWharfCalifornia_h 
#include <Arduino.h>
