...
const float Datum = 4.32 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.089,1.627,0.194,0.039,0.056,2.589,0,0.036,0.023,0,0.551,0.066,1.004,0.052,0.509,0.18,0.02,0.01,0.043,0.758,0,0,0.039,0.01,0.075,0.105,0.033,0.052,0.033,0.016,0.023,0,0.059,0,0,0.413,0};
