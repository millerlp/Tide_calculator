/*  TidelibLosAngelesouterharborCalifornia.cpp 
...
#include "TidelibLosAngelesouterharborCalifornia.h"
...
// Selection station ID number: 9410660
const long stationIDnumber = 9410660;
...
const float Datum = 2.82 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.066,1.125,0.197,0.026,0.039,1.69,0.01,0,0,0,0.397,0.049,0.715,0.036,0.351,0.128,0.013,0.01,0.01,0.666,0,0,0.039,0.01,0.056,0.075,0.026,0,0,0,0,0,0,0,0,0.217,0};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {219.1,207.7,135.5,134.2,222.6,145.5,350.1,0,0,0,123.7,95.1,192.3,236.9,204.6,185,186.1,167.5,314.1,141.1,0,0,129.7,166.4,88.1,130.2,182.1,0,0,0,0,0,0,0,0,184.4,0};
