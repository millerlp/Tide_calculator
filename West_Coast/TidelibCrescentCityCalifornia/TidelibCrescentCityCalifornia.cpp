/*  TidelibCrescentCityCalifornia.cpp 
...
#include "TidelibCrescentCityCalifornia.h"
...
// Selected station: Crescent City, California
char stationID[] = "Crescent City, California";
// Selection station ID number: 9419750
const long stationIDnumber = 9419750;
...
const prog_float_t Amp[] PROGMEM = {0.072,1.283,0.167,0.043,0.039,2.349,0,0,0,0,0.499,0.056,0.794,0.046,0.404,0.141,0.016,0.007,0.026,0.6,0,0,0.033,0.016,0.052,0.098,0.03,0,0,0,0,0,0.046,0,0,0.233,0.135};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {240,227.8,223.6,235.6,242.5,211,0,0,0,0,185.2,158.8,212.6,255,225.2,205.5,204.9,232.4,4.3,231.7,0,0,225.8,230.9,154,191.2,206.7,0,0,0,0,0,152,0,0,261.4,262.1};
