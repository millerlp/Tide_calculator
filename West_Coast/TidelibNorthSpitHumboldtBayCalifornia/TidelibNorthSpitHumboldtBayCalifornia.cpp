/*  TidelibNorthSpitHumboldtBayCalifornia.cpp 
...
// Selected station: North Spit, Humboldt Bay, California
char stationID[] = "North Spit, Humboldt Bay, California";
// Selection station ID number: 9418767
const long stationIDnumber = 9418767;
...
const float Datum = 3.7041 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.071,1.315,0.155,0.053,0.044,2.297,0,0.038,0.021,0,0.486,0.055,0.816,0.044,0.412,0.143,0.016,0.005,0.038,0.573,0,0,0.034,0.019,0.034,0.096,0.027,0.02,0,0.015,0.019,0,0.045,0,0,0.214,0.125};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {248.3,233.4,228.3,225.2,252.4,215.1,0,200.6,284.7,0,190.5,164.2,217.2,265.9,231.2,211.3,216.4,237.5,35,236.6,0,0,235.8,215.8,173,194.5,210.3,197.5,0,177.4,239.1,0,149,0,0,255,264.1};
