/*  TidelibNewportBeachNewportBayEntranceCoronadelMarCalifornia.cpp 
...
#include "TidelibNewportBeachNewportBayEntranceCoronadelMarCalifornia.h"
...
// Selected station: Newport Beach, Newport Bay Entrance, Corona del Mar, California
char stationID[] = "Newport Beach, Newport Bay Entrance, Corona del Mar, California";
// Selection station ID number: 9410580
const long stationIDnumber = 9410580;
...
const float Datum = 2.7723 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.066,1.102,0.197,0.049,0.039,1.66,0.01,0.01,0,0,0.39,0.052,0.705,0.036,0.348,0.128,0.016,0.007,0.02,0.669,0,0,0.039,0.013,0.052,0.072,0.026,0,0,0,0,0,0,0,0,0.207,0.046};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {218.4,208,133.1,148,218,144.4,354.2,282.4,0,0,124.1,97.3,192.7,239.5,203.3,184.4,177.5,140.1,312.8,140.2,0,0,128.8,142.4,84.2,126.2,186.2,0,0,0,0,0,0,0,0,183.4,280.2};
