/*  TidelibSeattlePugetSoundWashington.cpp 
...
#include "TidelibSeattlePugetSoundWashington.h"
...
// Selected station: Seattle, Puget Sound, Washington
char stationID[] = "Seattle, Puget Sound, Washington";
// Selection station ID number: 9447130
const long stationIDnumber = 9447130;
...
const float Datum = 6.64 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.131,2.736,0.259,0.148,0.089,3.517,0.016,0.069,0.03,0,0.709,0.079,1.512,0.105,0.846,0.246,0.026,0.007,0.052,0.879,0,0,0.052,0.066,0.112,0.148,0.049,0.112,0.112,0.03,0.039,0.026,0.072,0,0,0.253,0.108};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {315.2,277,37.9,56.1,319.8,10.6,342.4,200.2,313.6,0,340.8,308.7,254.6,328.9,276.6,249.9,251.5,38,44.2,37,0,0,37.1,48.4,236.6,354.9,246.6,78.1,46.7,174,229.9,282.6,140.5,0,0,292.9,231.1};
