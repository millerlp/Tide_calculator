/*  TidelibTonguePointAstoriaColumbiaRiverOregon.cpp 
...
#include "TidelibTonguePointAstoriaColumbiaRiverOregon.h"
...
// Selected station: Tongue Point, Astoria, Columbia River, Oregon
char stationID[] = "Tongue Point, Astoria, Columbia River, Oregon";
// Selection station ID number: 9439040
const long stationIDnumber = 9439040;
...
const float Datum = 4.5079 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.049,1.322,0.246,0.151,0.046,3.166,0.013,0.03,0.039,0.003,0.604,0.059,0.801,0.039,0.367,0.138,0.016,0.007,0.036,0.794,0.01,0,0.052,0.072,0.062,0.128,0.023,0.082,0.102,0.016,0.02,0.033,0.085,0,0,0.371,0.148};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {282.8,254.5,283.4,267.4,302.6,261.6,15.4,109.1,124.1,231.4,239.5,214,239.6,294.3,251.4,240,253.7,356.4,24.5,293.8,160,0,296.4,257.3,356.5,240.9,239.9,113.3,91.4,79.1,107.6,121.5,187.9,0,0,308.7,183};
