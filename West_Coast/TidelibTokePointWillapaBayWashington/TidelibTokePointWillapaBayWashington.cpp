/*  TidelibTokePointWillapaBayWashington.cpp 
...
#include "TidelibTokePointWillapaBayWashington.h"
...
// Selected station: Toke Point, Willapa Bay, Washington
char stationID[] = "Toke Point, Willapa Bay, Washington";
// Selection station ID number: 9440910
const long stationIDnumber = 9440910;
...
const float Datum = 4.7835 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.074,1.427,0.232,0.109,0.052,3.218,0,0.046,0.031,0,0.648,0.071,0.865,0.051,0.445,0.153,0.019,0.007,0.019,0.857,0,0,0.055,0.03,0.026,0.143,0.037,0.013,0.018,0.02,0.031,0,0.08,0,0,0.518,0};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {267.6,251.1,279.6,266.3,270.3,253.7,0,352.6,45.3,0,229.7,204.6,235.4,292.6,249.2,230.2,221,285.6,40.7,284.4,0,0,270.5,269.3,253.2,228.6,208.7,10.9,64.3,335.6,30.5,0,161.8,0,0,289.8,0};
