...
#include "TidelibPortOrfordOregon.h"
...
// Selected station: Port Orford, Oregon
char stationID[] = "Port Orford, Oregon";
// Selection station ID number: 9431647
const long stationIDnumber = 9431647;
...
const float Datum = 3.93 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.085,1.404,0.171,0.056,0.052,2.441,0.003,0.003,0.003,0,0.512,0.056,0.863,0.049,0.433,0.154,0.016,0.003,0.033,0.646,0.003,0,0.036,0.02,0.052,0.105,0.03,0.003,0,0.003,0.003,0,0,0,0,0.289,0};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {242.8,230.9,232.7,240.6,240.6,216.5,336.6,215.5,3.7,0,190.7,165.9,214.6,262.2,227.4,206.5,201.9,305.7,354.1,239,8.5,0,231.5,244.3,158.2,196,200.8,253.8,0,166.3,294.1,0,0,0,0,274,0};
