/*  TidelibFridayHarborSanJuanIslandSanJuanChannelWashington.cpp 
...
#include "TidelibFridayHarborSanJuanIslandSanJuanChannelWashington.h"
...
// Selected station: Friday Harbor, San Juan Island, San Juan Channel, Washington
char stationID[] = "Friday Harbor, San Juan Island, San Juan Channel, Washington";
// Selection station ID number: 9449880
const long stationIDnumber = 9449880;
...
const float Datum = 4.55 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.138,2.493,0.115,0.069,0.082,1.827,0.003,0.052,0.016,0.003,0.394,0.043,1.424,0.098,0.771,0.239,0.026,0.007,0.079,0.433,0.007,0.003,0.036,0.026,0.056,0.079,0.043,0.039,0.03,0.023,0.033,0.007,0.069,0.023,0.03,0.249,0.072};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {315.1,280.4,44,52.4,298,10.6,127.1,124.6,237.2,105.2,343,309.4,258.7,325.7,278,250.7,253.5,313.6,26.8,35.7,157,255.9,39.9,60,266.6,350.1,245.9,27.5,19.5,92,134,289.1,156.4,265.1,168.8,274.5,227.5};
