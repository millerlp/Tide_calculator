/*  TidelibPortAngelesStraitOfJuanDeFucaWashington.cpp 
...
#include "TidelibPortAngelesStraitOfJuanDeFucaWashington.h"
...
// Selected station: Port Angeles, Strait Of Juan De Fuca, Washington
char stationID[] = "Port Angeles, Strait Of Juan De Fuca, Washington";
// Selection station ID number: 9444090
const long stationIDnumber = 9444090;
...
const float Datum = 4.24 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.128,2.188,0.089,0.039,0.069,1.686,0.01,0.049,0.049,0,0.381,0.049,1.283,0.075,0.679,0.217,0.023,0.003,0.056,0.479,0,0,0.026,0.02,0.089,0.069,0.039,0.066,0.066,0.026,0.03,0,0.046,0,0.075,0.331,0};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {286,261.8,332.7,31.9,273.8,307.1,142.1,100.3,196.2,0,280.1,248.6,241.6,301.6,259.4,232.8,221.8,327.2,15.6,326.4,0,0,335.5,51.8,234,286.7,233.2,22.4,19.3,68.1,118.5,0,146.8,0,187.7,287.6,0};
