/*  TidelibCedarKeyGulfOfMexicoFlorida.cpp 
...
#include "TidelibCedarKeyGulfOfMexicoFlorida.h"
...
// Selected station: Cedar Key, Gulf Of Mexico, Florida
char stationID[] = "Cedar Key, Gulf Of Mexico, Florida";
// Selection station ID number: 8727520
const long stationIDnumber = 8727520;
...
const float Datum = 2.04 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.03,0.554,0.098,0.056,0.016,1.247,0.003,0.026,0.013,0.003,0.217,0.023,0.522,0.01,0.19,0.118,0.016,0.049,0.023,0.397,0.003,0.003,0.03,0.03,0.046,0.056,0.026,0.023,0.03,0.01,0.016,0.016,0,0,0,0.39,0.105};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {58.6,35,224.1,198.6,90.7,188.9,36.7,252.4,195.7,225,181.9,183.3,26.9,106.4,26.9,11.9,342,51.4,135,225.7,330.7,267.7,219.8,233.1,292,181,359.5,169.1,160.5,229.5,292,87.7,0,0,0,140,41.1};
