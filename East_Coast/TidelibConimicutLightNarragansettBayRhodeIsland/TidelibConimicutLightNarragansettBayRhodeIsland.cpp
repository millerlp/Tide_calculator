...
const float Datum = 2.1 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.016,0.223,0.118,0.072,0.013,1.946,0.03,0.302,0.059,0,0.482,0.075,0.167,0.016,0.082,0.043,0.003,0.003,0.046,0.427,0.033,0,0.039,0.01,0.089,0.075,0.007,0.039,0.052,0.135,0.079,0.01,0,0,0,0.197,0};
