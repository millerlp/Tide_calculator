/*  TidelibConimicutLightNarragansettBayRhodeIsland.cpp 
...
#include "TidelibConimicutLightNarragansettBayRhodeIsland.h"
...
// Selected station: Conimicut Light, Narragansett Bay, Rhode Island
char stationID[] = "Conimicut Light, Narragansett Bay, Rhode Island";
// Selection station ID number: 8452944
const long stationIDnumber = 8452944;
...
const float Datum = 2.1063 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.017,0.223,0.117,0.071,0.012,1.945,0.03,0.301,0.058,0,0.483,0.074,0.167,0.015,0.081,0.043,0.004,0.003,0.047,0.425,0.034,0,0.038,0.01,0.09,0.077,0.006,0.04,0.054,0.135,0.08,0.011,0,0,0,0.196,0};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {201.6,165.7,28.6,338.3,178.1,7.2,30.1,58.3,304.4,0,351.9,340.9,198.6,169.1,183.2,183.7,231.2,30.9,120.5,30,23.5,0,10.2,18.1,354.4,344.6,212.7,28.8,3.1,9.9,142.4,43,0,0,0,131.8,0};
