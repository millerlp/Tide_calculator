/*  TidelibColdSpringHarborOysterBayNewYork.cpp 
...
#include "TidelibColdSpringHarborOysterBayNewYork.h"
...
// Selected station: Cold Spring Harbor, Oyster Bay, New York
char stationID[] = "Cold Spring Harbor, Oyster Bay, New York";
// Selection station ID number: 8516061
const long stationIDnumber = 8516061;
...
const prog_float_t Amp[] PROGMEM = {0.016,0.331,0.167,0.105,0.016,3.737,0,0.075,0.112,0.013,0.761,0.102,0.213,0.01,0.108,0.043,0.007,0.003,0,0.62,0.007,0.003,0.036,0.026,0.089,0.148,0.007,0,0,0,0,0,0,0,0,0.213,0.079};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {171.6,188,146.9,141.4,204.4,115.8,0,146.9,173.2,279.7,90.3,64.7,221.1,155,190.5,237.6,254,145.7,0,144.5,148.8,291,143.4,129.1,300.1,93.7,235.3,0,0,0,0,0,0,0,0,135.5,60.1};
