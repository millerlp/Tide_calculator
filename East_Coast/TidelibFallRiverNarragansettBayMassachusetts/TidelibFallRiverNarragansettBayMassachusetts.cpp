/*  TidelibFallRiverNarragansettBayMassachusetts.cpp 
...
#include "TidelibFallRiverNarragansettBayMassachusetts.h"
...
// Selected station: Fall River, Narragansett Bay, Massachusetts
char stationID[] = "Fall River, Narragansett Bay, Massachusetts";
// Selection station ID number: 8447386
const long stationIDnumber = 8447386;
...
const float Datum = 2.2047 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.023,0.229,0.118,0.067,0.013,2.015,0.032,0.333,0.071,0,0.495,0.07,0.172,0.013,0.086,0.043,0.004,0.003,0.056,0.429,0.037,0.011,0.037,0.013,0.097,0.081,0.006,0.043,0.058,0.146,0.089,0,0,0,0,0.196,0};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {205.3,168.9,30.2,344.4,183.3,8.7,35.9,64.8,335.4,0,353.5,341.1,200.3,172.6,185.1,182.2,231.5,32.1,124.7,31.1,29.3,338.6,17.1,341.6,0.2,348.5,213.8,29.8,9.9,15,149.6,0,0,0,0,131.8,0};
