...
#include "TidelibKeyWestFlorida.h"
...
// Selected station: Key West, Florida
char stationID[] = "Key West, Florida";
// Selection station ID number: 8724580
const long stationIDnumber = 8724580;
...
const float Datum = 0.8924 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.016,0.295,0.05,0.018,0.022,0.609,0,0.031,0,0,0.122,0.016,0.31,0.014,0.096,0.076,0.011,0.001,0.017,0.169,0,0,0.013,0.004,0.015,0.024,0.015,0,0,0.016,0.014,0,0.038,0,0,0.262,0.135};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {358.4,356.1,92.4,95.4,354.1,66.9,0,250.7,0,0,48.3,35.4,352.2,359.9,358.7,342.1,326.8,89.2,359.2,88.2,0,0,73.8,76.7,7.1,53.9,339.3,0,0,232.3,247.5,0,354.6,0,0,187.8,56.5};
