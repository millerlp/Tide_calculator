/*  TidelibWindmillPointRappahannockRiverVirginia.cpp 
...
#include "TidelibWindmillPointRappahannockRiverVirginia.h"
...
// Selected station: Windmill Point, Rappahannock River, Virginia
char stationID[] = "Windmill Point, Rappahannock River, Virginia";
// Selection station ID number: 8636580
const long stationIDnumber = 8636580;
...
const float Datum = 0.7021 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.007,0.098,0.03,0.016,0.007,0.574,0,0.03,0.01,0,0.125,0.016,0.075,0.003,0.026,0.016,0.003,0,0.01,0.098,0,0,0.01,0.003,0.013,0.026,0.003,0,0,0.013,0,0,0,0,0,0.299,0.098};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {217.1,226.7,124.2,116,236.2,103.2,0,87.6,97.6,0,84,64.3,245.9,207.4,230.4,239.8,264.8,0,334.1,124.3,0,0,113.7,112.9,82.4,82.8,254,0,0,59.1,0,0,0,0,0,156.3,48};
