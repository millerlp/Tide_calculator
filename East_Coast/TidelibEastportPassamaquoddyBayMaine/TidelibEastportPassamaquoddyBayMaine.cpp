/*  TidelibEastportPassamaquoddyBayMaine.cpp 
...
#include "TidelibEastportPassamaquoddyBayMaine.h"
...
// Selected station: Eastport, Passamaquoddy Bay, Maine
char stationID[] = "Eastport, Passamaquoddy Bay, Maine";
// Selection station ID number: 8410140
const long stationIDnumber = 8410140;
...
const float Datum = 9.7047 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.03,0.511,0.38,0.444,0.019,8.815,0,0.197,0.166,0.015,1.781,0.213,0.392,0.018,0.171,0.066,0.01,0.03,0.034,1.378,0,0,0.123,0.174,0.067,0.413,0.01,0,0.018,0.075,0.058,0.015,0,0,0,0,0.053};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {208.6,196.4,138.3,134.5,206.8,98.7,0,86.5,277.2,253.7,69.4,46.5,176.9,230.6,195.5,163,157.5,356.5,110.2,139.3,0,0,115.8,122.8,163.9,73.5,154,0,331.6,55.8,131.9,83.9,0,0,0,0,127.6};
