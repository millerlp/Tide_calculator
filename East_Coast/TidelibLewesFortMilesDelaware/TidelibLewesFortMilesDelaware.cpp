/*  TidelibLewesFortMilesDelaware.cpp 
...
#include "TidelibLewesFortMilesDelaware.h"
...
// Selected station: Lewes, Fort Miles, Delaware
char stationID[] = "Lewes, Fort Miles, Delaware";
// Selection station ID number: 8557380
const long stationIDnumber = 8557380;
...
const float Datum = 2.231 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.022,0.338,0.099,0.065,0.012,2.02,0.011,0.042,0.019,0,0.438,0.054,0.273,0.013,0.11,0.043,0.007,0.011,0.025,0.355,0,0,0.036,0.028,0.039,0.093,0.011,0,0,0.023,0.013,0,0,0,0,0.172,0.101};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {194.7,201.7,51.9,48,221.4,31.1,110,186.3,349.5,0,10.6,356.6,188.6,239.3,199.1,182.9,175.5,280.3,133.1,56.8,0,0,30.5,55,16.9,11.4,177.4,0,0,177.8,205.9,0,0,0,0,140.5,41.3};
