/*  TidelibNewLondonThamesRiverConnecticut.cpp 
...
#include "TidelibNewLondonThamesRiverConnecticut.h"
...
// Selected station: New London, Thames River, Connecticut
char stationID[] = "New London, Thames River, Connecticut";
// Selection station ID number: 8461490
const long stationIDnumber = 8461490;
...
const float Datum = 1.5354 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.019,0.244,0.06,0.036,0.017,1.22,0.012,0.085,0.039,0,0.285,0.041,0.174,0.011,0.074,0.05,0.01,0.002,0.022,0.223,0.012,0,0.022,0.02,0.045,0.056,0.006,0.017,0.014,0.046,0.012,0,0,0,0,0.181,0.059};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {215.6,178.5,70.8,127.1,253.9,58.3,66.4,343.7,206.1,0,34.6,13.4,209,209.8,189.8,193.4,233.8,70.4,145.5,69.9,344.1,0,52.4,113.2,347.7,44.8,222,28.9,15.2,313.3,5.7,0,0,0,0,135.3,69.4};
