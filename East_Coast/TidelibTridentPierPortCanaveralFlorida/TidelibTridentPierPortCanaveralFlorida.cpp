/*  TidelibTridentPierPortCanaveralFlorida.cpp 
...
#include "TidelibTridentPierPortCanaveralFlorida.h"
...
// Selected station: Trident Pier, Port Canaveral, Florida
char stationID[] = "Trident Pier, Port Canaveral, Florida";
// Selection station ID number: 8721604
const long stationIDnumber = 8721604;
...
const float Datum = 1.8799 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.018,0.325,0.069,0.042,0.011,1.686,0.01,0.012,0.026,0,0.401,0.057,0.25,0.016,0.109,0.054,0.006,0.011,0.021,0.264,0.013,0,0.03,0.015,0.054,0.079,0.009,0,0,0,0.015,0,0,0,0,0.318,0.204};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {211,200,28.8,41.3,218,7.3,49.2,133.2,307.2,0,345.4,326.4,206.6,217.2,201.6,198.7,213,231.5,174.1,27,204,0,12.5,27.2,350.3,346.3,209.3,0,0,0,91.3,0,0,0,0,195.3,49.2};
