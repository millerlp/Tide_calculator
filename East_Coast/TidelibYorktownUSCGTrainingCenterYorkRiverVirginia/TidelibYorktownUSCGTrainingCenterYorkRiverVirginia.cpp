/*  TidelibYorktownUSCGTrainingCenterYorkRiverVirginia.cpp 
...
#include "TidelibYorktownUSCGTrainingCenterYorkRiverVirginia.h"
...
// Selected station: Yorktown USCG Training Center, York River, Virginia
char stationID[] = "Yorktown USCG Training Center, York River, Virginia";
// Selection station ID number: 8637689
const long stationIDnumber = 8637689;
...
const float Datum = 1.2402 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.006,0.157,0.05,0.046,0.008,1.081,0.009,0.024,0.01,0.001,0.244,0.027,0.119,0.004,0.043,0.024,0.006,0.009,0.032,0.192,0.013,0.003,0.019,0.018,0.033,0.048,0.005,0.012,0.012,0.013,0.008,0.002,0,0,0.087,0.306,0.183};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {225,196.7,74.4,62.5,223.2,52.9,122.4,46.4,74.5,160.7,33.7,20.8,221.8,223,194.3,200.2,142.9,315.5,127,78.3,22.8,349.3,86.5,60.4,54,33.6,174.8,114.2,129.7,4.4,182.5,354.3,0,0,63,146.1,62.1};
