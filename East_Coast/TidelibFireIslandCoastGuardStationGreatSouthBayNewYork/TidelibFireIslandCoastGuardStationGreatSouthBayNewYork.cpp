/*  TidelibFireIslandCoastGuardStationGreatSouthBayNewYork.cpp 
...
#include "TidelibFireIslandCoastGuardStationGreatSouthBayNewYork.h"
...
// Selected station: Fire Island Coast Guard Station, Great South Bay, New York
char stationID[] = "Fire Island Coast Guard Station, Great South Bay, New York";
// Selection station ID number: 8515186
const long stationIDnumber = 8515186;
...
const float Datum = 1.1286 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.01,0.159,0.04,0.025,0.008,0.904,0,0.024,0.002,0.002,0.182,0.024,0.123,0.005,0.052,0.024,0.003,0,0,0.146,0.011,0.006,0.01,0.007,0.022,0.035,0.004,0,0,0,0,0,0,0,0,0.22,0.092};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {200,199,32.7,25.8,197.3,9,0,249.6,154.4,252.3,351.7,334.4,195.6,200.3,198.9,194.1,193.5,0,0,30.9,303.7,138.3,30,19.2,347,354,193.4,0,0,0,0,0,0,0,0,129.1,42.9};
