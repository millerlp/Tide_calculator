/*  TidelibFortPointPortsmouthHarborNewHampshire.cpp 
...
#include "TidelibFortPointPortsmouthHarborNewHampshire.h"
...
// Selected station: Fort Point, Portsmouth Harbor, New Hampshire
char stationID[] = "Fort Point, Portsmouth Harbor, New Hampshire";
// Selection station ID number: 8423898
const long stationIDnumber = 8423898;
...
const float Datum = 4.6916 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.026,0.443,0.21,0.154,0.016,4.311,0.003,0.059,0.03,0.007,0.965,0.161,0.374,0.013,0.135,0.066,0.01,0.089,0.033,0.594,0.003,0,0.075,0.062,0.03,0.207,0.013,0.013,0.02,0.023,0.016,0.023,0,0,0,0.105,0.066};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {214.2,203.3,131.8,140.3,250.2,105.9,156.2,324.5,134.7,293.2,76.1,49.3,187.1,247.6,204.1,156.6,38,130.7,168.7,136.2,162.9,0,94.5,144.8,24,85.2,159.4,244.9,225.4,317.9,23.9,156.6,0,0,0,128.3,105.8};
