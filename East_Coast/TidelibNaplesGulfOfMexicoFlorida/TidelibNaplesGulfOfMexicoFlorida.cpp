/*  TidelibNaplesGulfOfMexicoFlorida.cpp 
...
#include "TidelibNaplesGulfOfMexicoFlorida.h"
...
// Selected station: Naples, Gulf Of Mexico, Florida
char stationID[] = "Naples, Gulf Of Mexico, Florida";
// Selection station ID number: 8725110
const long stationIDnumber = 8725110;
...
const float Datum = 1.65 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.026,0.479,0.085,0.033,0.016,0.886,0.01,0.056,0.026,0,0.177,0.023,0.443,0.01,0.157,0.102,0.016,0.007,0.049,0.289,0.01,0.003,0.016,0.01,0.026,0.036,0.016,0.03,0.03,0.023,0.023,0.003,0.033,0,0,0.315,0.135};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {15.4,9.3,150.3,181.1,40.7,144.8,327.8,119.8,130.1,0,130.2,124.5,3.3,1.3,6.7,353.4,342.1,52.5,107.9,157.1,247.3,358.1,148.4,196.9,58.4,140.6,351.9,314.3,298.5,86.4,141.9,120.5,342.7,0,0,158.5,42.3};
