/*  TidelibFortescueCreekNewJersey.cpp 
...
// Selected station: Fortescue Creek, New Jersey
char stationID[] = "Fortescue Creek, New Jersey";
// Selection station ID number: 8536931
const long stationIDnumber = 8536931;
...
const float Datum = 3.1955 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.022,0.376,0.111,0.077,0.02,2.718,0,0.121,0.058,0.007,0.593,0.079,0.279,0.012,0.124,0.053,0.006,0.003,0,0.408,0.003,0.001,0.024,0.018,0.065,0.116,0.01,0,0,0,0,0,0,0,0,0.19,0.105};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {224.4,216.5,92.7,71.7,208.4,56.4,0,15.2,212.6,131.9,41.1,25.8,200.2,232.5,215.3,192.4,184.5,91.3,0,89.9,348.2,284.5,88.6,72,22.8,43.1,193.4,0,0,0,0,0,0,0,0,147.7,40.3};
