/*  TidelibJacksonvilleBeachFlorida.cpp 
...
#include "TidelibJacksonvilleBeachFlorida.h"
...
// Selected station: Jacksonville Beach, Florida
char stationID[] = "Jacksonville Beach, Florida";
// Selection station ID number: 8720291
const long stationIDnumber = 8720291;
...
const float Datum = 2.5459 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.02,0.358,0.11,0.069,0.018,2.477,0,0.039,0.019,0.006,0.578,0.077,0.259,0.011,0.119,0.05,0.007,0.003,0,0.405,0.015,0.01,0.024,0.017,0.059,0.112,0.01,0,0,0,0,0,0,0,0,0.331,0.197};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {187.1,193.1,36.7,38.4,199.3,15.6,0,19.1,92.2,332.2,352.9,330.2,205.5,180.8,194.1,211.7,217.8,35.9,0,35.1,293.6,290.5,34.3,24.8,193.2,356,210.9,0,0,0,0,0,0,0,0,193.3,52};
