/*  TidelibLynnLynnHarborMassachusetts.cpp 
...
#include "TidelibLynnLynnHarborMassachusetts.h"
...
// Selected station: Lynn, Lynn Harbor, Massachusetts
char stationID[] = "Lynn, Lynn Harbor, Massachusetts";
// Selection station ID number: 8443187
const long stationIDnumber = 8443187;
...
const prog_float_t Amp[] PROGMEM = {0.039,0.443,0.197,0.24,0.026,4.39,0.016,0.062,0.079,0.013,1.076,0.125,0.387,0.016,0.151,0.079,0.013,0.148,0.062,0.781,0,0.003,0.105,0.072,0.056,0.167,0.016,0.016,0.026,0.039,0.023,0.02,0,0,0,0.105,0.059};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {204.3,208,127,168.3,199.6,109.7,137.4,28.9,285.9,220.5,78.1,61.6,185.3,201.6,217,186.4,162,10.3,139.9,151.5,0,347,146.3,152.1,72.4,83.2,91.9,244.1,202.8,8.3,70.8,113.5,0,0,0,126.3,89.8};
