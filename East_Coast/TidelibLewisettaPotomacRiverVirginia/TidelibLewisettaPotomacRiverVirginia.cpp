/*  TidelibLewisettaPotomacRiverVirginia.cpp 
...
#include "TidelibLewisettaPotomacRiverVirginia.h"
...
// Selected station: Lewisetta, Potomac River, Virginia
char stationID[] = "Lewisetta, Potomac River, Virginia";
// Selection station ID number: 8635750
const long stationIDnumber = 8635750;
...
const prog_float_t Amp[] PROGMEM = {0.005,0.074,0.027,0.037,0.004,0.605,0,0.014,0.011,0,0.131,0.016,0.061,0.003,0.028,0.013,0.002,0.001,0.026,0.091,0,0,0.005,0.012,0,0.027,0.002,0,0,0,0,0,0,0,0,0.265,0.126};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {264.9,276.2,201.3,203.3,287.4,176.4,0,204.4,265.1,0,152.3,130.3,298.7,253.5,293,287.1,321.1,201,311,200,0,0,199.1,203.8,0,151.3,308.4,0,0,0,0,0,0,0,0,133.1,35.7};
