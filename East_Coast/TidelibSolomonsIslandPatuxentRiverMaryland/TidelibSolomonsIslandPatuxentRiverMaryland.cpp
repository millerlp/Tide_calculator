/*  TidelibSolomonsIslandPatuxentRiverMaryland.cpp 
...
#include "TidelibSolomonsIslandPatuxentRiverMaryland.h"
...
// Selected station: Solomons Island, Patuxent River, Maryland
char stationID[] = "Solomons Island, Patuxent River, Maryland";
// Selection station ID number: 8577330
const long stationIDnumber = 8577330;
...
const float Datum = 0.7546 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.006,0.09,0.027,0.038,0.005,0.562,0,0.018,0.011,0,0.118,0.014,0.076,0.003,0.04,0.019,0.002,0.001,0.047,0.084,0,0,0.005,0.012,0,0.026,0.003,0.011,0.01,0,0,0,0,0,0,0.285,0.112};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {307.3,315.6,223.5,233.8,324,198.8,0,276.5,301.2,0,172.3,149.6,332.4,298.8,318.9,306.7,349.1,227,290.5,225.9,0,0,224.7,229.3,0,177.8,339.6,331.8,324.8,0,0,0,0,0,0,131.4,36.1};
