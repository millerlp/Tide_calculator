/*  TidelibMontaukPointLightLongIslandSoundNewYork.cpp 
...
#include "TidelibMontaukPointLightLongIslandSoundNewYork.h"
...
// Selected station: Montauk Point Light, Long Island Sound, New York
char stationID[] = "Montauk Point Light, Long Island Sound, New York";
// Selection station ID number: 8510321
const long stationIDnumber = 8510321;
...
const float Datum = 1.35 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.01,0.223,0.075,0.036,0.01,1.237,0.016,0.049,0.049,0,0.292,0.043,0.135,0.007,0.052,0.039,0.003,0.003,0.023,0.279,0,0,0.016,0.007,0.066,0.056,0.007,0.013,0.02,0,0.033,0,0,0,0,0.174,0.056};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {144.4,161.1,18.8,269.2,177.7,0.7,55.7,123.7,199.5,0,345,331,194.3,127.7,158.4,170,227.7,26.2,194,26.2,0,0,26.1,12.5,341.7,339.4,208.7,347.9,328.9,0,148.8,0,0,0,0,145.7,64.4};
