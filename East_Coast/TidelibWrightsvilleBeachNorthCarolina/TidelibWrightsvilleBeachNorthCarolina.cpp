/*  TidelibWrightsvilleBeachNorthCarolina.cpp 
...
#include "TidelibWrightsvilleBeachNorthCarolina.h"
...
// Selected station: Wrightsville Beach, North Carolina
char stationID[] = "Wrightsville Beach, North Carolina";
// Selection station ID number: 8658163
const long stationIDnumber = 8658163;
...
const float Datum = 2.0407 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.019,0.314,0.089,0.061,0,1.946,0.036,0.035,0.021,0,0.465,0.062,0.227,0,0.108,0.05,0,0,0.033,0.337,0.035,0,0.034,0.017,0.07,0.09,0.016,0,0,0.028,0.029,0,0,0,0,0.354,0.194};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {177.7,186.4,13.2,358.3,0,353.1,25.1,267.7,25.4,0,333.7,317.6,192.6,0,187.5,186.1,0,0,136.5,14.1,307.4,0,355.7,4.5,338.6,331.2,175.3,0,0,242.1,154.3,0,0,0,0,165,50.3};
