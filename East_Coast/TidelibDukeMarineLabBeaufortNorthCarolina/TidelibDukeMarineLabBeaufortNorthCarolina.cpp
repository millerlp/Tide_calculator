/*  TidelibDukeMarineLabBeaufortNorthCarolina.cpp 
...
#include "TidelibDukeMarineLabBeaufortNorthCarolina.h"
...
// Selected station: Duke Marine Lab, Beaufort, North Carolina
char stationID[] = "Duke Marine Lab, Beaufort, North Carolina";
// Selection station ID number: 8656483
const long stationIDnumber = 8656483;
...
const float Datum = 1.71 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.016,0.269,0.066,0.066,0.01,1.496,0.016,0.013,0.023,0.007,0.335,0.046,0.21,0.01,0.089,0.043,0.007,0.013,0.033,0.236,0.02,0.003,0.023,0.02,0.036,0.066,0.01,0.01,0.013,0.01,0.02,0.007,0,0,0,0.299,0.167};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {198.7,197.8,27.3,8,222.2,6.4,33.7,294.8,54.4,118.2,349.4,338.4,205,218.4,198.8,199.6,187.6,243.1,178.1,30,302.3,140.8,15.3,6.7,14.7,345.6,209.6,15.5,17,228.6,132.2,28.7,0,0,0,166.4,43.7};
