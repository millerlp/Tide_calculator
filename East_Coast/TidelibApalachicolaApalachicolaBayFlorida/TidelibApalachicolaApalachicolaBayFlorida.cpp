/*  TidelibApalachicolaApalachicolaBayFlorida.cpp 
...
#include "TidelibApalachicolaApalachicolaBayFlorida.h"
...
// Selected station: Apalachicola, Apalachicola Bay, Florida
char stationID[] = "Apalachicola, Apalachicola Bay, Florida";
// Selection station ID number: 8728690
const long stationIDnumber = 8728690;
...
const float Datum = 0.91 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.02,0.443,0.052,0.023,0.013,0.407,0.007,0.02,0.003,0,0.072,0.007,0.397,0.02,0.135,0.089,0.007,0.007,0.026,0.131,0.007,0.003,0.01,0.01,0.02,0.02,0.02,0.026,0.023,0.007,0.007,0.007,0,0.056,0,0.358,0.161};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {81.1,52.8,258,263.1,125.4,256.9,322.3,75,250.3,0,245.1,258.6,45.7,101.9,55.6,30.7,344.7,246.7,85.5,285,190.8,271.7,305.1,293.6,58.3,262,16.8,254.9,249.2,43.9,94.6,148.5,0,32.6,0,145.5,45.5};
