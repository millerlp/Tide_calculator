/*  TidelibTolchesterBeachChesapeakeBayMaryland.cpp 
...
#include "TidelibTolchesterBeachChesapeakeBayMaryland.h"
...
// Selected station: Tolchester Beach, Chesapeake Bay, Maryland
char stationID[] = "Tolchester Beach, Chesapeake Bay, Maryland";
// Selection station ID number: 8573364
const long stationIDnumber = 8573364;
...
const float Datum = 0.8333 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.016,0.226,0.033,0.026,0.013,0.571,0,0.013,0,0,0.121,0.013,0.19,0.01,0.075,0.043,0.02,0,0.075,0.079,0,0,0.003,0.02,0,0.02,0.007,0.013,0,0,0,0,0,0,0,0.413,0.174};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {332.6,3.3,5.5,31.2,8.6,346.6,0,215.1,0,0,324.1,296.7,14,352.5,352.4,346.5,298.7,0,283.1,8,0,0,7,21.4,0,323.7,18.6,173.5,0,0,0,0,0,0,0,138.3,47.9};
