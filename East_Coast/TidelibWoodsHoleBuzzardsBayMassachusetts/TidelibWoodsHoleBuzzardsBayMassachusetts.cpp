/*  TidelibWoodsHoleBuzzardsBayMassachusetts.cpp 
...
#include "TidelibWoodsHoleBuzzardsBayMassachusetts.h"
...
// Selected station: Woods Hole, Buzzards Bay, Massachusetts
char stationID[] = "Woods Hole, Buzzards Bay, Massachusetts";
// Selection station ID number: 8447930
const long stationIDnumber = 8447930;
...
const float Datum = 0.9843 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.02,0.232,0.052,0.029,0.014,0.796,0.015,0.178,0.066,0.014,0.264,0.046,0.218,0.01,0.09,0.049,0.005,0.002,0.022,0.199,0.014,0,0.017,0.005,0.077,0.032,0.011,0.036,0.035,0.079,0.035,0,0,0,0,0.168,0};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {212.4,189,29.7,252,182.9,34.6,24.9,355.1,45.5,165.8,19.4,2.4,203.7,174.2,199.9,185.1,218.2,35.7,117.2,35.6,347.2,0,25,35.1,352.2,25.9,184.9,13.6,344.7,315.4,56.4,0,0,0,0,145.9,0};
