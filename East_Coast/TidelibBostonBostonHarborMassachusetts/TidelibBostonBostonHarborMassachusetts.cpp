/*  TidelibBostonBostonHarborMassachusetts.cpp 
...
#include "TidelibBostonBostonHarborMassachusetts.h"
...
// Selected station: Boston, Boston Harbor, Massachusetts
char stationID[] = "Boston, Boston Harbor, Massachusetts";
// Selection station ID number: 8443970
const long stationIDnumber = 8443970;
...
const float Datum = 5.2001 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.032,0.468,0.192,0.181,0.024,4.588,0,0.077,0.11,0.02,1.014,0.129,0.389,0.015,0.154,0.068,0.01,0.017,0.012,0.7,0,0,0.062,0.072,0.033,0.22,0.011,0.018,0.023,0.037,0.031,0,0,0,0,0.105,0.058};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {213.5,205.2,144.5,156.2,214.4,109.4,0,25.9,282.1,237.1,78.9,55,186.7,227,202.1,171.1,168.3,8.2,122.8,146.2,0,0,123.9,143.2,69,85.5,152.8,232.5,207.9,14.6,68.7,0,0,0,0,126.3,89.8};
