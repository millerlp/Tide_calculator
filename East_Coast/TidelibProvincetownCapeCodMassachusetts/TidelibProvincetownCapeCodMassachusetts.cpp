/*  TidelibProvincetownCapeCodMassachusetts.cpp 
...
#include "TidelibProvincetownCapeCodMassachusetts.h"
...
// Selected station: Provincetown, Cape Cod, Massachusetts
char stationID[] = "Provincetown, Cape Cod, Massachusetts";
// Selection station ID number: 8446121
const long stationIDnumber = 8446121;
...
const float Datum = 5.0295 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.03,0.446,0.23,0.266,0.023,4.485,0.013,0.072,0.131,0.003,1.06,0.105,0.39,0.016,0.141,0.059,0.007,0,0.016,0.574,0.003,0.003,0.036,0.066,0.013,0.236,0.01,0.016,0.023,0.033,0.023,0.007,0,0,0,0.105,0.059};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {211.9,206.1,138.8,170.3,201.7,112,152.2,9.7,294.6,48.6,78.8,74.7,187.9,235.5,201.7,172,198.3,0,221.2,151.3,102.7,157.6,96.9,141.9,56.5,91.9,194.4,245.8,216.6,351.1,55.6,102.2,0,0,0,126.3,89.8};
