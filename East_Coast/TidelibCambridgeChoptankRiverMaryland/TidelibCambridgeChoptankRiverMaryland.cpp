/*  TidelibCambridgeChoptankRiverMaryland.cpp 
...
#include "TidelibCambridgeChoptankRiverMaryland.h"
...
// Selected station: Cambridge, Choptank River, Maryland
char stationID[] = "Cambridge, Choptank River, Maryland";
// Selection station ID number: 8571892
const long stationIDnumber = 8571892;
...
const float Datum = 1.0138 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.01,0.164,0.039,0.062,0.009,0.783,0,0.035,0,0,0.153,0.018,0.129,0.005,0.064,0.022,0.003,0.001,0.061,0.119,0,0,0.013,0.021,0,0.036,0.005,0.018,0.016,0.014,0.01,0,0,0,0,0.281,0.108};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {337.2,340.4,283.8,289.7,348,263.2,0,90.5,0,0,240.6,222.8,355.9,324.8,336.3,329.6,11.2,286.6,305.8,285.6,0,0,269.3,287,0,245.1,2.4,82,79.6,58.1,129.7,0,0,0,0,133.4,40.2};
