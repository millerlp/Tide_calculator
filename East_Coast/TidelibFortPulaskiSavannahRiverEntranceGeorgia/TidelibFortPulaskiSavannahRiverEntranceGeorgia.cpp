/*  TidelibFortPulaskiSavannahRiverEntranceGeorgia.cpp 
...
#include "TidelibFortPulaskiSavannahRiverEntranceGeorgia.h"
...
// Selected station: Fort Pulaski, Savannah River Entrance, Georgia
char stationID[] = "Fort Pulaski, Savannah River Entrance, Georgia";
// Selection station ID number: 8670870
const long stationIDnumber = 8670870;
...
const float Datum = 3.8222 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.019,0.362,0.133,0.145,0.02,3.325,0.078,0.138,0.02,0,0.717,0.093,0.258,0.018,0.129,0.057,0.007,0.035,0.063,0.517,0.024,0,0.062,0.059,0.106,0.143,0.011,0.031,0.016,0.065,0.076,0.01,0,0,0,0.277,0.196};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {228,200.7,45.9,12.2,249.2,17.9,152.1,248.1,60.4,0,2.2,349.1,206.5,213.3,199.8,198.9,212.2,285.6,168.1,45.8,49.4,0,30.7,5.6,50.2,355.4,204.7,33.1,77,241.9,274.4,122.4,0,0,0,176,51.8};
