/*  TidelibSpringmaidPierSouthCarolina.cpp 
...
#include "TidelibSpringmaidPierSouthCarolina.h"
...
// Selected station: Springmaid Pier, South Carolina
char stationID[] = "Springmaid Pier, South Carolina";
// Selection station ID number: 8661070
const long stationIDnumber = 8661070;
...
const float Datum = 2.71 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.023,0.329,0.106,0.086,0.013,2.432,0.066,0.021,0.01,0,0.585,0.084,0.241,0.015,0.113,0.052,0.011,0.011,0.061,0.413,0.021,0,0.044,0.017,0.081,0.108,0.009,0,0.021,0.02,0.04,0.014,0,0,0,0.272,0.175};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {186.2,188.8,21.9,3.9,185.7,357.6,59.1,262.8,317.7,0,338.4,320.3,192.9,198.8,188.2,185.1,114.6,250.1,145.4,18.6,31.1,0,2.3,12.2,350.9,335.9,194.7,0,64.3,282.8,240,27.9,0,0,0,170.9,50.1};
