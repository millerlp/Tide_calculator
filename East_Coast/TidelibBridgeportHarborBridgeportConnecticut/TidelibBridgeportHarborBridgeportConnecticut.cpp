/*  TidelibBridgeportHarborBridgeportConnecticut.cpp 
...
#include "TidelibBridgeportHarborBridgeportConnecticut.h"
...
// Selected station: Bridgeport Harbor, Bridgeport, Connecticut
char stationID[] = "Bridgeport Harbor, Bridgeport, Connecticut";
// Selection station ID number: 8467150
const long stationIDnumber = 8467150;
...
const float Datum = 3.622 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.021,0.318,0.15,0.162,0.024,3.251,0.012,0.039,0.044,0,0.656,0.077,0.21,0.017,0.098,0.059,0.014,0.004,0.031,0.515,0,0,0.054,0.068,0,0.148,0.015,0.023,0.015,0.024,0,0,0,0,0,0.207,0.072};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {237,191.6,134.7,134.1,264.4,109.6,200.1,127.4,353.9,0,87.6,65.6,219.5,228.7,204.1,205.7,238.8,136.9,175.5,135.9,0,0,106.4,131.1,0,89.8,258.1,198.8,203.7,97.2,0,0,0,0,0,132,61.2};
