/*  TidelibKingsBayNavyBaseGeorgia.cpp 
...
#include "TidelibKingsBayNavyBaseGeorgia.h"
...
// Selected station: Kings Bay, Navy Base, Georgia
char stationID[] = "Kings Bay, Navy Base, Georgia";
// Selection station ID number: 8679511
const long stationIDnumber = 8679511;
...
const float Datum = 3.5564 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.02,0.348,0.131,0.131,0.03,3.117,0.033,0.131,0.033,0.016,0.679,0.085,0.262,0.01,0.118,0.059,0.007,0.039,0.062,0.509,0.023,0,0.066,0.075,0.112,0.164,0.01,0.059,0.033,0.066,0.072,0.01,0,0,0,0,0};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {205.2,209.5,66.1,29.2,261.7,36.3,183,207.5,165.8,317.4,19.7,340.1,218,200.9,207.2,217.2,226.4,307,174.3,67.7,353.4,0,45.9,30.4,70.2,19.2,221.7,31.7,45.1,205,236.8,96.2,0,0,0,0,0};
