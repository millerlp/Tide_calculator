...
#include "TidelibPensacolaFlorida.h"
...
// Selected station: Pensacola, Florida
char stationID[] = "Pensacola, Florida";
// Selection station ID number: 8729840
const long stationIDnumber = 8729840;
...
const float Datum = 0.6168 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.024,0.505,0.028,0.002,0.011,0.082,0,0,0,0,0.016,0.002,0.495,0.054,0.152,0.108,0.011,0,0.011,0.03,0,0,0.002,0.001,0,0.003,0.021,0,0,0,0,0,0,0,0,0.287,0.156};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {78.3,52.2,188,156.5,103.2,170.3,0,0,0,0,184.1,197.9,42.3,29.6,54.9,30.1,11.6,0,93.7,163.7,0,0,164,167.2,0,182.3,22.5,0,0,0,0,0,0,0,0,148.3,43.2};
