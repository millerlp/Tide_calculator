/*  TidelibAtlanticCityNewJersey.cpp 
...
#include "TidelibAtlanticCityNewJersey.h"
...
// Selected station: Atlantic City, New Jersey
char stationID[] = "Atlantic City, New Jersey";
// Selection station ID number: 8534720
const long stationIDnumber = 8534720;
...
const float Datum = 2.2146 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.021,0.362,0.103,0.063,0.014,1.948,0.021,0.033,0.019,0,0.462,0.066,0.246,0.01,0.109,0.038,0.006,0.003,0.018,0.381,0,0,0.029,0.018,0.065,0.084,0.009,0,0.011,0.019,0,0,0,0,0,0.233,0.1};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {174.2,183.2,18.7,6.3,214.4,355.4,37.5,181.7,84.8,0,335.9,319.5,166.1,203.7,178.5,168.7,149,18.7,114.7,17.8,0,0,0.2,13.6,341.1,336.6,158.8,0,33.2,156.9,0,0,0,0,0,145.5,40};
