/*  TidelibOregonInletMarinaPamlicoSoundNorthCarolina.cpp 
...
#include "TidelibOregonInletMarinaPamlicoSoundNorthCarolina.h"
...
// Selected station: Oregon Inlet Marina, Pamlico Sound, North Carolina
char stationID[] = "Oregon Inlet Marina, Pamlico Sound, North Carolina";
// Selection station ID number: 8652587
const long stationIDnumber = 8652587;
...
const float Datum = 0.58 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.01,0.092,0.013,0.01,0.007,0.394,0.003,0.03,0.013,0.003,0.092,0.013,0.066,0.003,0.043,0.01,0.003,0.01,0.039,0.062,0,0,0.007,0.007,0.013,0.02,0.007,0.013,0.007,0.01,0.013,0.003,0,0,0.062,0.243,0.105};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {211.2,190.9,23.4,34.2,210.3,16.6,356.3,346.3,209.5,194.2,358.9,351.7,194.1,175,218.6,219.8,336.9,238.2,248.9,32.5,0,0,14.4,41,27.4,351.5,218.4,166.1,185.5,327.9,28.2,332.2,0,0,56.5,154.6,56.9};
