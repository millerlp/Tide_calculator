/*  TidelibNewportNarragansettBayRhodeIsland.cpp 
...
#include "TidelibNewportNarragansettBayRhodeIsland.h"
...
// Selected station: Newport, Narragansett Bay, Rhode Island
char stationID[] = "Newport, Narragansett Bay, Rhode Island";
// Selection station ID number: 8452660
const long stationIDnumber = 8452660;
...
const float Datum = 1.7356 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.017,0.203,0.098,0.036,0.013,1.656,0.021,0.188,0.017,0.003,0.406,0.058,0.153,0.012,0.072,0.041,0.008,0.005,0.024,0.354,0.022,0.003,0.029,0.007,0.082,0.07,0.011,0.028,0.033,0.085,0.045,0.007,0,0,0.056,0.2,0.052};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {181.1,166.1,21.7,349.9,204,2.3,34.1,35.8,220.1,330.4,345.8,333,202,195.7,176.6,185.3,172.9,252.2,121.9,25,5.1,222.9,9,345.5,344.5,341,230.9,19.5,357.1,347.9,106.4,48.8,0,0,73.9,145.3,75.1};
