/*  TidelibStPetersburgTampaBayFlorida.cpp 
...
#include "TidelibStPetersburgTampaBayFlorida.h"
...
// Selected station: St. Petersburg, Tampa Bay, Florida
char stationID[] = "St. Petersburg, Tampa Bay, Florida";
// Selection station ID number: 8726520
const long stationIDnumber = 8726520;
...
const float Datum = 1.2008 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.027,0.547,0.081,0.036,0.017,0.574,0,0.011,0,0,0.098,0.012,0.507,0.021,0.162,0.095,0.016,0.001,0.056,0.186,0,0,0.013,0.014,0.03,0.029,0.017,0.012,0,0,0,0,0,0,0,0.301,0.107};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {91.1,49.9,215,219.8,79.3,197,0,230.8,0,0,191.3,193.5,37.7,62,57.6,26.2,9.5,212.4,138.5,211.7,0,0,187.1,226.2,20.7,198.7,4.2,129,0,0,0,0,0,0,0,150.8,41};
