/*  TidelibLakeWorthPierFlorida.cpp 
...
#include "TidelibLakeWorthPierFlorida.h"
...
// Selected station: Lake Worth Pier, Florida
char stationID[] = "Lake Worth Pier, Florida";
// Selection station ID number: 8722670
const long stationIDnumber = 8722670;
...
const float Datum = 1.5092 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.01,0.194,0.072,0.062,0.01,1.332,0.01,0.01,0.007,0,0.331,0.043,0.144,0.007,0.052,0.036,0.003,0.023,0.016,0.23,0.01,0,0.02,0.016,0.043,0.056,0.007,0.003,0.007,0.01,0.007,0.007,0,0,0,0.272,0.18};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {213.4,221.4,34.5,28.2,230.5,13.9,41.9,190.2,329.3,0,353.6,349.3,235.7,209.8,195.9,229.1,321.1,242,333.4,29.4,259.7,0,354.5,54.6,354.2,352,91.7,167,121.9,160.8,129.6,19.1,0,0,0,190.6,58.3};
