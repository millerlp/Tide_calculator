/*  TidelibChesapeakeBayBridge-TunnelVirginia.cpp 
...
#include "TidelibChesapeakeBayBridge-TunnelVirginia.h"
...
// Selected station: Chesapeake Bay Bridge-Tunnel, Virginia
char stationID[] = "Chesapeake Bay Bridge-Tunnel, Virginia";
// Selection station ID number: 8638863
const long stationIDnumber = 8638863;
...
const float Datum = 1.414 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.013,0.189,0.061,0.047,0.013,1.246,0,0.017,0.019,0,0.294,0.042,0.149,0.011,0.06,0.029,0.004,0.002,0.035,0.227,0,0,0.019,0.011,0.039,0.055,0.01,0,0,0.01,0.011,0,0,0,0,0.179,0.138};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {201.5,184.9,46.4,28.8,204,21,0,199.7,293.4,0,1.4,347.4,208.9,215.2,188.1,191.1,232.6,46.9,83.3,45.8,0,0,35.7,35.7,13.7,359.2,201.1,0,0,199.2,147.5,0,0,0,0,152,34};
