/*  TidelibUSCGStationTheNarrowsNewYork.cpp 
...
#include "TidelibUSCGStationTheNarrowsNewYork.h"
...
// Selected station: USCG Station, The Narrows, New York
char stationID[] = "USCG Station, The Narrows, New York";
// Selection station ID number: 8519050
const long stationIDnumber = 8519050;
...
const float Datum = 2.5131 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.013,0.363,0.1,0.062,0.012,2.186,0,0.075,0.048,0.003,0.488,0.066,0.165,0.007,0.12,0.031,0.003,0.003,0,0.371,0.018,0.003,0.022,0.016,0.052,0.095,0.007,0,0,0,0,0,0,0,0,0.22,0.092};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {166.5,170.2,35.8,24.1,173.6,8.8,0,245.9,117.6,345.1,353.5,338.1,177.5,162.8,170.8,181.1,185.3,34.9,0,33.8,92.1,63,32.7,20.4,343.7,355.5,181.1,0,0,0,0,0,0,0,0,129.1,42.9};
