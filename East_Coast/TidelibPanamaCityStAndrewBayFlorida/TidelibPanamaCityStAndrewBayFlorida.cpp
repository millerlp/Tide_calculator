/*  TidelibPanamaCityStAndrewBayFlorida.cpp 
...
#include "TidelibPanamaCityStAndrewBayFlorida.h"
...
// Selected station: Panama City, St. Andrew Bay, Florida
char stationID[] = "Panama City, St. Andrew Bay, Florida";
// Selection station ID number: 8729108
const long stationIDnumber = 8729108;
...
const float Datum = 0.67 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.026,0.466,0.026,0.007,0.02,0.095,0.003,0.01,0.007,0,0.02,0.003,0.446,0.023,0.148,0.095,0.013,0.003,0.02,0.039,0.003,0,0.003,0.003,0.003,0.003,0.023,0.007,0.007,0.003,0.003,0.003,0,0,0,0.374,0.154};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {51.4,34.8,118.6,116.5,67.6,136.1,266.3,346,95.3,0,156.3,139.9,25.6,22.6,37.8,12,346.3,203.1,164.7,149.6,67.8,0,93.5,100.2,180.5,159.1,15.8,84.7,69,299.8,355.7,331.1,0,0,0,149.3,45.3};
