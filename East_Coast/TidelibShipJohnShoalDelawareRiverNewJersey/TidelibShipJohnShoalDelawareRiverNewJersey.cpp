/*  TidelibShipJohnShoalDelawareRiverNewJersey.cpp 
...
#include "TidelibShipJohnShoalDelawareRiverNewJersey.h"
...
// Selected station: Ship John Shoal, Delaware River, New Jersey
char stationID[] = "Ship John Shoal, Delaware River, New Jersey";
// Selection station ID number: 8537121
const long stationIDnumber = 8537121;
...
const float Datum = 3.0479 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.02,0.335,0.112,0.246,0.033,2.733,0.016,0.118,0.066,0.01,0.538,0.039,0.262,0.007,0.112,0.052,0.016,0.007,0.049,0.41,0.01,0.003,0.039,0.046,0.059,0.167,0.01,0.039,0.046,0.062,0.033,0.01,0.03,0.164,0.075,0.394,0.253};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {217.1,221.1,100.4,47,258.2,72.2,119.9,40,274.5,200.3,61.3,55.4,206.9,25.5,220.4,222,25.3,251.9,183.4,100.5,55.7,34.5,72.9,95.5,164.6,35.1,23.7,162.2,135.1,29.1,96.6,21.3,111.6,20.9,49,120.3,55.4};
