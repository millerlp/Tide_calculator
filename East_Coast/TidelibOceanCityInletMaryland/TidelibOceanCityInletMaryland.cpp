/*  TidelibOceanCityInletMaryland.cpp 
...
#include "TidelibOceanCityInletMaryland.h"
...
// Selected station: Ocean City Inlet, Maryland
char stationID[] = "Ocean City Inlet, Maryland";
// Selection station ID number: 8570283
const long stationIDnumber = 8570283;
...
const float Datum = 1.2795 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.009,0.179,0.05,0.038,0.005,0.999,0.006,0.067,0.007,0.007,0.23,0.032,0.17,0.006,0.063,0.026,0.001,0.01,0.011,0.18,0.01,0.001,0.02,0.01,0.028,0.046,0.009,0.021,0.022,0.029,0.013,0.004,0,0,0.087,0.288,0.148};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {197.8,210.5,30.5,28.2,249.8,8.6,13,171.6,268.2,346.3,348.5,333.4,200,203.7,198.9,191.3,215.5,249.8,153.8,31.5,210.9,199.3,6.9,20.4,342,346,181.6,359.5,0.9,152.5,187.9,28.4,0,0,69.5,147.2,69.2};
