/*  TidelibVacaKeyFloridaBayFlorida.cpp 
...
#include "TidelibVacaKeyFloridaBayFlorida.h"
...
// Selected station: Vaca Key, Florida Bay, Florida
char stationID[] = "Vaca Key, Florida Bay, Florida";
// Selection station ID number: 8723970
const long stationIDnumber = 8723970;
...
const float Datum = 0.51 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.01,0.239,0.02,0.02,0.013,0.184,0.007,0.049,0.023,0.003,0.023,0,0.243,0.003,0.072,0.056,0.007,0.007,0.01,0.049,0.003,0,0.003,0.007,0.026,0.01,0.01,0.026,0.023,0.016,0.03,0.007,0.049,0.059,0.039,0.348,0.131};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {88.2,33.7,235.8,192.1,79.1,164.6,161.8,80,56.1,274.1,121,0,26.8,38.8,38.9,16.8,13.6,188.9,139.2,229,156.2,0,229.8,185.8,359.6,175.6,14.5,264.6,254.9,71.3,111.1,67.6,4,18.7,359.7,186.1,79.7};
