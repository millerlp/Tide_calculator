/*  TidelibVirginiaKeyBearCutBiscayneBayFlorida.cpp 
...
#include "TidelibVirginiaKeyBearCutBiscayneBayFlorida.h"
...
// Selected station: Virginia Key, Bear Cut, Biscayne Bay, Florida
char stationID[] = "Virginia Key, Bear Cut, Biscayne Bay, Florida";
// Selection station ID number: 8723214
const long stationIDnumber = 8723214;
...
const float Datum = 1.0991 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.007,0.103,0.046,0.049,0.006,0.977,0,0.023,0.035,0,0.218,0.029,0.092,0.004,0.031,0.021,0.002,0.001,0,0.172,0,0,0.02,0.013,0.021,0.046,0.003,0.012,0,0,0.013,0,0,0,0,0.271,0.18};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {250.6,263.2,68.9,51,275.7,41,0,69.5,169.4,0,21.5,6.3,288.4,237.8,263.1,298.2,313.5,72.6,0,71.3,0,0,61.4,64.5,45.5,17.6,299.3,275.3,0,0,112.4,0,0,0,0,190.6,58.3};
