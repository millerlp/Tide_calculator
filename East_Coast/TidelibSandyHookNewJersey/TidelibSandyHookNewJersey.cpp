...
#include "TidelibSandyHookNewJersey.h"
...
// Selected station: Sandy Hook, New Jersey
char stationID[] = "Sandy Hook, New Jersey";
// Selection station ID number: 8531680
const long stationIDnumber = 8531680;
...
const float Datum = 2.5755 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.017,0.338,0.126,0.087,0.013,2.258,0.035,0.052,0.056,0,0.518,0.069,0.176,0.016,0.103,0.037,0.005,0.003,0.032,0.438,0.034,0,0.034,0.026,0.08,0.095,0.007,0.016,0.027,0.026,0.038,0,0,0,0,0.221,0.091};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {209.2,175.7,31.5,359.8,220.8,6,56.4,269.7,83.8,0,348.6,336.8,172.5,218.7,180.2,183.1,169.2,33.8,124.9,32.6,11.4,0,17.4,359.7,14.5,345.7,171.1,52.4,33.8,275.8,224.3,0,0,0,0,129.1,42.9};
