/*  TidelibCapeCharlesHarborUSCGWharfChesapeakeBayVirginia.cpp 
...
#include "TidelibCapeCharlesHarborUSCGWharfChesapeakeBayVirginia.h"
...
// Selection station ID number: 8632366
const long stationIDnumber = 8632366;
...
const prog_float_t Amp[] PROGMEM = {0.01,0.171,0.052,0.033,0.01,1.122,0,0.036,0.013,0,0.249,0.033,0.125,0.007,0.056,0.023,0.003,0,0,0.197,0.007,0.003,0.013,0.007,0.026,0.049,0.003,0,0,0,0,0,0,0,0,0.19,0.128};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {189.5,198.4,71.7,64.5,207.3,44.3,0,325.4,333.2,0,24.2,4.3,216.6,180.4,199.8,225.9,234.2,0,0,69.6,307.7,248,68.6,56.1,19,26.9,227.3,0,0,0,0,0,0,0,0,150.6,37.6};
