...
const float Datum = 3.8944 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.017,0.288,0.146,0.09,0.017,3.215,0,0.212,0.046,0.008,0.68,0.09,0.232,0.01,0.095,0.044,0.006,0.003,0,0.542,0.026,0.006,0.033,0.023,0.076,0.131,0.01,0,0,0,0,0,0,0,0,0.276,0.197};
