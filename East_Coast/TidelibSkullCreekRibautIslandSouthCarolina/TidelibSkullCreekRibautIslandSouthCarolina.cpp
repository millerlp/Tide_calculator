/*  TidelibSkullCreekRibautIslandSouthCarolina.cpp 
...
#include "TidelibSkullCreekRibautIslandSouthCarolina.h"
...
// Selected station: Skull Creek, Ribaut Island, South Carolina
char stationID[] = "Skull Creek, Ribaut Island, South Carolina";
// Selection station ID number: 8668918
const long stationIDnumber = 8668918;
...
const float Datum = 3.89 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.016,0.289,0.148,0.089,0.016,3.215,0,0.213,0.046,0.007,0.679,0.089,0.233,0.01,0.095,0.043,0.007,0.003,0,0.541,0.026,0.007,0.033,0.023,0.075,0.131,0.01,0,0,0,0,0,0,0,0,0.276,0.197};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {213.6,211.8,58.3,39.6,208.4,25.5,0,252.2,108.2,336.8,11.8,357.9,206,216.2,211.6,203.4,201.8,57,0,55.8,75.2,13.1,54.6,39.6,355.2,13.6,204.5,0,0,0,0,0,0,0,0,176,51.8};
