/*  TidelibTheBatteryNewYorkHarborNewYork.cpp 
...
// Selected station: The Battery, New York Harbor, New York
char stationID[] = "The Battery, New York Harbor, New York";
// Selection station ID number: 8518750
const long stationIDnumber = 8518750;
...
const float Datum = 2.5689 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.015,0.333,0.116,0.081,0.011,2.189,0.032,0.082,0.084,0.014,0.507,0.067,0.169,0.015,0.102,0.035,0.004,0.003,0.044,0.42,0.034,0,0.037,0.025,0.07,0.086,0.006,0.026,0.027,0.038,0.05,0,0,0,0,0.23,0.098};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {211.3,179.6,43.9,27.8,229.8,19,68,258.2,151.2,326.7,0,347.7,176.3,220.1,183.9,190.7,172.9,44.4,128,43.3,18.8,0,30.5,25,10,357.8,174.9,71.6,49.3,262.7,247.2,0,0,0,0,129.9,47.4};
