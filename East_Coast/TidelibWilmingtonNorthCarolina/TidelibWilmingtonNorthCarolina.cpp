/*  TidelibWilmingtonNorthCarolina.cpp 
...
// Selected station: Wilmington, North Carolina
char stationID[] = "Wilmington, North Carolina";
// Selection station ID number: 8658120
const long stationIDnumber = 8658120;
...
const float Datum = 2.4377 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.015,0.261,0.074,0.187,0.01,2.044,0.025,0.177,0.107,0.017,0.412,0.046,0.196,0.011,0.093,0.043,0.005,0.002,0.068,0.258,0.014,0,0.029,0.063,0.077,0.093,0.007,0.044,0.049,0.077,0.06,0,0,0.067,0.074,0,0.166};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {263.6,229.8,95,58.9,221.8,63.1,147.6,6.9,284.2,253.6,51,44.5,233.5,245.4,236.6,237.5,237.2,99.2,199.3,97.7,126.8,0,82.5,56.6,150.3,41.5,235.1,109.8,100.4,355.8,30,0,0,36.6,16.3,0,24.9};
