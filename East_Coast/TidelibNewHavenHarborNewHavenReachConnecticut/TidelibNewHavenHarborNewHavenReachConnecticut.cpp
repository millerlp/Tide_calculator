/*  TidelibNewHavenHarborNewHavenReachConnecticut.cpp 
...
#include "TidelibNewHavenHarborNewHavenReachConnecticut.h"
...
// Selected station: New Haven Harbor, New Haven Reach, Connecticut
char stationID[] = "New Haven Harbor, New Haven Reach, Connecticut";
// Selection station ID number: 8465705
const long stationIDnumber = 8465705;
...
const float Datum = 3.3202 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.027,0.305,0.131,0.169,0.01,2.93,0.012,0.012,0.087,0,0.62,0.086,0.211,0.015,0.098,0.046,0.005,0.004,0.053,0.47,0,0,0.042,0.062,0.013,0.14,0.014,0.012,0.013,0.012,0,0,0,0,0,0.207,0.072};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {248.9,190,131.1,143.8,228.7,106.4,162.4,101.8,350,0,81.7,72,218.4,229.6,203.7,210.7,246.5,131.8,113.2,130.7,0,0,99.6,133.6,321.5,86.3,173.1,186.5,186.1,67.4,0,0,0,0,0,132,61.2};
