/*  TidelibCharlestonCooperRiverEntranceSouthCarolina.cpp 
...
#include "RTClib.h"
#include "TidelibCharlestonCooperRiverEntranceSouthCarolina.h"
...
// Selected station: Charleston, Cooper River Entrance, South Carolina
char stationID[] = "Charleston, Cooper River Entrance, South Carolina";
...
const float Datum = 2.9232 ; // units in feet
...
PROGMEM prog_float_t Amp[] = {0.018,0.345,0.1,0.11,0.015,2.569,0.056,0.108,0.02,0,0.564,0.071,0.26,0.016,0.119,0.057,0.007,0.018,0.06,0.39,0,0,0.05,0.044,0.083,0.114,0.013,0.025,0.017,0.046,0.032,0,0,0,0,0.255,0.173};
PROGMEM prog_float_t Kappa[] = {213.5,199.7,37.1,5,243.3,10.4,114.8,209.6,135.3,0,354.9,343.3,203.4,217.3,198.3,198.9,207.1,263.8,173.9,36.1,0,0,19.9,356.1,40,351.4,198,4.4,30.6,201.4,237.7,0,0,0,0,176.3,50.5};
...
PROGMEM prog_uint32_t startSecs[] = {1388534400,1420070400,1451606400,1483228800,1514764800,1546300800,1577836800,1609459200,1640995200,1672531200};

// 1st year of data in the Equilarg/Nodefactor/startSecs arrays.
const unsigned int startYear = 2014;
//------------------------------------------------------------------
