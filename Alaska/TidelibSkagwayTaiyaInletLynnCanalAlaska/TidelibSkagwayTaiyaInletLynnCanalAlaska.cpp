/*  TidelibSkagwayTaiyaInletLynnCanalAlaska.cpp 
...
#include "TidelibSkagwayTaiyaInletLynnCanalAlaska.h"
...
// Selected station: Skagway, Taiya Inlet, Lynn Canal, Alaska
char stationID[] = "Skagway, Taiya Inlet, Lynn Canal, Alaska";
// Selection station ID number: 9452400
const long stationIDnumber = 9452400;
...
const float Datum = 8.83 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.102,1.736,0.614,0.154,0.056,6.657,0.046,0.135,0.056,0.007,1.352,0.161,1.04,0.059,0.541,0.184,0.023,0.02,0.023,2.3,0.013,0,0.118,0.046,0.161,0.262,0.036,0.075,0.046,0.052,0.082,0.026,0.095,0.033,0.052,0.22,0.026};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {280.8,265.6,310.6,289.7,276.3,284.1,359.6,26,69,207.1,260.3,235.9,250.5,295.1,261.4,243.6,242.2,95.7,50.5,317.9,78.3,0,314.8,273,255.9,263,240.9,267.6,201.4,358.1,64.2,93.7,197.1,20.1,143.5,191.5,312.7};
