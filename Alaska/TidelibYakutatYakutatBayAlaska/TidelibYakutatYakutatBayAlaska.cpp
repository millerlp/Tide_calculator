/*  TidelibYakutatYakutatBayAlaska.cpp 
...
#include "TidelibYakutatYakutatBayAlaska.h"
...
// Selected station: Yakutat, Yakutat Bay, Alaska
char stationID[] = "Yakutat, Yakutat Bay, Alaska";
// Selection station ID number: 9453220
const long stationIDnumber = 9453220;
...
const float Datum = 5.3 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.089,1.499,0.322,0.075,0.052,3.701,0.01,0.003,0.007,0.007,0.768,0.092,0.925,0.052,0.466,0.164,0.02,0.003,0.049,1.207,0.007,0.003,0.072,0.023,0.089,0.148,0.03,0.003,0.003,0,0.007,0.007,0.112,0.046,0.066,0.371,0};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {280.2,268,305.8,299.3,275.4,281.4,266.4,309.1,309.1,230.8,257.2,232.3,252.9,296,264.4,246.3,241.3,59,19.1,312.7,245.8,186.4,303.9,298.8,235.2,260.7,245.7,26.6,232.8,0,35.4,123.9,203.2,346.3,172.8,257.9,0};
