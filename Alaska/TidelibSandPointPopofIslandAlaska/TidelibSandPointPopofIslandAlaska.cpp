/*  TidelibSandPointPopofIslandAlaska.cpp 
...
#include "TidelibSandPointPopofIslandAlaska.h"
...
// Selected station: Sand Point, Popof Island, Alaska
char stationID[] = "Sand Point, Popof Island, Alaska";
// Selection station ID number: 9459450
const long stationIDnumber = 9459450;
...
const float Datum = 3.88 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.082,1.362,0.217,0.052,0.049,2.405,0.007,0.01,0.03,0.003,0.522,0.062,0.873,0.046,0.427,0.157,0.016,0,0.03,0.797,0.007,0.007,0.049,0.016,0.059,0.102,0.033,0.003,0.003,0.003,0.01,0.007,0,0,0,0.466,0};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {297.6,285.1,343.1,343.7,293.7,322.2,226.1,276.1,26.4,36.6,299.3,273.8,270.3,315.6,281.7,263.3,269,0,65,349.4,200.8,282.8,340.2,335.6,276.2,303,262.2,118.4,359.7,264.9,301.8,173.9,0,0,0,266.4,0};
