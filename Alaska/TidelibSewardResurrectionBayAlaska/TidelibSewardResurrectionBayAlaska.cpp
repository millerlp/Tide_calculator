/*  TidelibSewardResurrectionBayAlaska.cpp 
...
#include "TidelibSewardResurrectionBayAlaska.h"
...
// Selected station: Seward, Resurrection Bay, Alaska
char stationID[] = "Seward, Resurrection Bay, Alaska";
// Selection station ID number: 9455090
const long stationIDnumber = 9455090;
...
const float Datum = 5.56 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.092,1.519,0.361,0.085,0.059,3.93,0.013,0.033,0.02,0.003,0.804,0.092,0.948,0.052,0.476,0.167,0.016,0.003,0.03,1.348,0.007,0.003,0.085,0.023,0.098,0.154,0.03,0.007,0.003,0.01,0.02,0.003,0.089,0,0,0.463,0};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {286.4,272.9,312.7,312.4,278.5,288,276,22.3,28.6,21.2,264,239.1,257.7,295,268.8,250.3,245.1,348.9,51.4,319.5,10,210.7,312.4,307.1,238.8,267.2,253.4,131.1,139.3,343.6,95.2,122.6,181.9,0,0,242.9,0};
