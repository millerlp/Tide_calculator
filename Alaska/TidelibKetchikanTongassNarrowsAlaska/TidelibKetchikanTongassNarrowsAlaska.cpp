/*  TidelibKetchikanTongassNarrowsAlaska.cpp 
...
#include "TidelibKetchikanTongassNarrowsAlaska.h"
...
// Selected station: Ketchikan, Tongass Narrows, Alaska
char stationID[] = "Ketchikan, Tongass Narrows, Alaska";
// Selection station ID number: 9450460
const long stationIDnumber = 9450460;
...
const float Datum = 8.0643 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.097,1.684,0.564,0.137,0.053,6.173,0.06,0.051,0,0,1.252,0.146,1.021,0.055,0.533,0.178,0.022,0.025,0.048,2.046,0.011,0,0.116,0.039,0.134,0.241,0.035,0.015,0.013,0.02,0.042,0.014,0.087,0,0,0.377,0.102};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {275.5,261.1,295.2,281.3,276.3,270.1,336.4,291.6,0,0,245.6,219.6,244.9,292.1,258.5,237.4,236.6,340.5,45,301.8,16.3,0,296.9,277.9,231.3,250,241,9.8,53.1,273.2,332.5,98.5,173,0,0,273.7,161.1};
