/*  TidelibPortLionsKodiakIslandAlaska.cpp 
...
#include "TidelibPortLionsKodiakIslandAlaska.h"
...
// Selected station: Port Lions, Kodiak Island, Alaska
char stationID[] = "Port Lions, Kodiak Island, Alaska";
// Selection station ID number: 9457391
const long stationIDnumber = 9457391;
...
const float Datum = 4.7802 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.068,1.298,0.346,0.095,0.061,3.399,0,0.026,0.044,0.014,0.677,0.09,0.859,0.037,0.429,0.167,0.022,0.01,0,1.272,0.005,0.013,0.075,0.024,0.082,0.131,0.032,0,0,0,0,0,0,0,0,0.256,0.049};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {293.2,286.6,344.9,331.2,280.1,308.4,0,15.8,102.5,236.6,285.6,262.7,273.4,299.8,285.6,266.9,260.3,343.5,0,342.2,176.7,225,340.8,324.1,328.9,288.6,267.8,0,0,0,0,0,0,0,0,262.1,151.7};
