/*  TidelibSitkaBaronofIslandSitkaSoundAlaska.cpp 
...
// Selected station: Sitka, Baronof Island, Sitka Sound, Alaska
char stationID[] = "Sitka, Baronof Island, Sitka Sound, Alaska";
// Selection station ID number: 9451600
const long stationIDnumber = 9451600;
...
const float Datum = 5.29 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.089,1.516,0.322,0.079,0.052,3.629,0,0,0,0,0.755,0.089,0.919,0.052,0.476,0.161,0.016,0.01,0.036,1.165,0,0,0.069,0.026,0.085,0.144,0.033,0,0,0,0,0,0.089,0,0,0.397,0};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {272.9,259.9,298.4,288.8,273.4,273.8,0,0,0,0,249.2,223.8,244.4,289.1,257.6,237.2,240.5,306,35.3,304.9,0,0,296.6,293,228.7,253.6,238.9,0,0,0,0,0,176.8,0,0,274.8,0};
