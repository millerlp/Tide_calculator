/*  TidelibJuneauGastineauChannelStephensPassAlaska.cpp 
...
#include "TidelibJuneauGastineauChannelStephensPassAlaska.h"
...
// Selected station: Juneau, Gastineau Channel, Stephens Pass, Alaska
char stationID[] = "Juneau, Gastineau Channel, Stephens Pass, Alaska";
// Selection station ID number: 9452210
const long stationIDnumber = 9452210;
...
const float Datum = 8.5663 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.101,1.706,0.623,0.149,0.057,6.545,0.043,0.126,0.015,0,1.33,0.155,1.02,0.058,0.539,0.179,0.019,0.014,0.025,2.231,0.017,0,0.117,0.044,0.146,0.257,0.034,0.088,0.066,0.048,0.071,0.017,0.081,0,0,0.264,0};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {277.7,265,309,289.2,281,282.5,0.8,8.9,239.8,0,258.2,231.4,250.2,294,263.7,243.7,241.6,9.6,55.6,315.5,55.6,0,309.6,285.7,251.7,262.8,241.4,255.2,197.3,335.8,47.7,96.6,176.1,0,0,255.6,0};
