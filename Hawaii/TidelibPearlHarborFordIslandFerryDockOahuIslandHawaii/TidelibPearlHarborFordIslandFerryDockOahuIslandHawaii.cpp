/*  TidelibPearlHarborFordIslandFerryDockOahuIslandHawaii.cpp 
...
#include "TidelibPearlHarborFordIslandFerryDockOahuIslandHawaii.h"
...
const int adjustGMT = 10;     // Time zone adjustment to get time in GMT.
...
// Selected station: Pearl Harbor, Ford Island Ferry Dock, Oahu Island, Hawaii
char stationID[] = "Pearl Harbor, Ford Island Ferry Dock, Oahu Island, Hawaii";
// Selection station ID number: 1612404
const long stationIDnumber = 1612404;
...
const float Datum = 0.8563 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.021,0.505,0.05,0.015,0.019,0.535,0,0.014,0.001,0.002,0.104,0.014,0.266,0.011,0.167,0.052,0.007,0.001,0,0.184,0.004,0.002,0.011,0.004,0.013,0.02,0.01,0,0,0,0,0,0,0,0,0.131,0};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {227.9,223.7,57.9,79.6,219.7,64.9,0,286.6,141.3,17,50.1,34.8,215.5,232,223.1,211.4,207.2,58.2,0,58.4,35,282.4,58.7,61.9,115.5,52.1,212,0,0,0,0,0,0,0,0,191.5,0};
