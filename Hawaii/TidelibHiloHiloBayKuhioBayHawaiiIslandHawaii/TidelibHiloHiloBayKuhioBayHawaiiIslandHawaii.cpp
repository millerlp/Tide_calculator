/*  TidelibHiloHiloBayKuhioBayHawaiiIslandHawaii.cpp 
...
#include "TidelibHiloHiloBayKuhioBayHawaiiIslandHawaii.h"
...
// Selected station: Hilo, Hilo Bay, Kuhio Bay, Hawaii Island, Hawaii
char stationID[] = "Hilo, Hilo Bay, Kuhio Bay, Hawaii Island, Hawaii";
// Selection station ID number: 1617760
const long stationIDnumber = 1617760;
...
const float Datum = 1.145 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.036,0.549,0.091,0.018,0.016,0.755,0,0,0,0,0.144,0.019,0.301,0.022,0.168,0.052,0.008,0.002,0.01,0.303,0,0,0.019,0.005,0.027,0.029,0.011,0,0,0,0,0,0.024,0,0,0.14,0};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {245.3,233.4,26.2,23.1,252,29.4,0,0,0,0,21.4,13.6,223.2,263,231.8,213.2,213.1,34.3,222.9,34.1,0,0,33,31.6,358.3,23.1,218.8,0,0,0,0,0,38,0,0,208.2,0};
