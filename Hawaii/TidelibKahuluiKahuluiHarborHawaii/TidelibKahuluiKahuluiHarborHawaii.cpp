/*  TidelibKahuluiKahuluiHarborHawaii.cpp 
...
#include "TidelibKahuluiKahuluiHarborHawaii.h"
...
// Selected station: Kahului, Kahului Harbor, Hawaii
char stationID[] = "Kahului, Kahului Harbor, Hawaii";
// Selection station ID number: 1615680
const long stationIDnumber = 1615680;
...
const float Datum = 1.1122 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.036,0.568,0.093,0.017,0.019,0.612,0,0,0,0,0.115,0.015,0.32,0.022,0.176,0.048,0.008,0.003,0,0.32,0,0,0.021,0.004,0.026,0.02,0.012,0,0,0,0,0,0.02,0,0,0.125,0};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {239.2,233.4,8.8,0.6,254.8,8.6,0,0,0,0,0.6,355.1,220.1,251.8,230.2,210.1,207,15.8,0,15.5,0,0,13.2,11.8,342.4,4.3,221,0,0,0,0,0,34.7,0,0,199.5,0};
