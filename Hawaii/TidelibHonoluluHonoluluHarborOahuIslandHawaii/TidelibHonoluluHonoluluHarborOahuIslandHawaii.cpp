/*  TidelibHonoluluHonoluluHarborOahuIslandHawaii.cpp 
...
#include "TidelibHonoluluHonoluluHarborOahuIslandHawaii.h"
...
// Selected station: Honolulu, Honolulu Harbor, Oahu Island, Hawaii
char stationID[] = "Honolulu, Honolulu Harbor, Oahu Island, Hawaii";
// Selection station ID number: 1612340
const long stationIDnumber = 1612340;
...
const float Datum = 0.8235 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.034,0.518,0.053,0.016,0.016,0.583,0,0,0,0,0.113,0.014,0.284,0.021,0.159,0.046,0.007,0.001,0,0.186,0,0,0.011,0.004,0.016,0.021,0.011,0,0,0,0,0,0.022,0,0,0.131,0};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {239.5,227,47.9,69.3,240.3,59.5,0,0,0,0,49.5,37.6,215.7,252.8,226.2,208.3,204.6,53.6,0,53.8,0,0,53.9,56.9,8.8,60.8,211,0,0,0,0,0,48.2,0,0,191.5,0};
