/*  TidelibNawiliwiliNawiliwiliHarborKauaiIslandHawaii.cpp 
...
#include "TidelibNawiliwiliNawiliwiliHarborKauaiIslandHawaii.h"
...
// Selected station: Nawiliwili, Nawiliwili Harbor, Kauai Island, Hawaii
char stationID[] = "Nawiliwili, Nawiliwili Harbor, Kauai Island, Hawaii";
// Selection station ID number: 1611400
const long stationIDnumber = 1611400;
...
const float Datum = 0.8268 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.03,0.482,0.049,0.013,0.016,0.489,0,0.013,0,0,0.092,0.01,0.276,0.023,0.148,0.043,0.007,0,0,0.18,0,0,0.01,0.003,0.016,0.016,0.01,0,0,0,0,0,0,0,0,0.138,0};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {245.8,229.9,32.9,48,253.9,48.3,0,203.8,0,0,38.8,39.7,221.8,258.5,227.1,213.8,213.8,0,0,45.8,0,0,45.8,47.1,354.6,40.7,221.4,0,0,0,0,0,0,0,0,193.1,0};
