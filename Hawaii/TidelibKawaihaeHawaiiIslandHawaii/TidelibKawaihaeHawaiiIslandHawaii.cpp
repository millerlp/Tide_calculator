/*  TidelibKawaihaeHawaiiIslandHawaii.cpp 
...
#include "TidelibKawaihaeHawaiiIslandHawaii.h"
...
// Selected station: Kawaihae, Hawaii Island, Hawaii
char stationID[] = "Kawaihae, Hawaii Island, Hawaii";
// Selection station ID number: 1617433
const long stationIDnumber = 1617433;
...
const float Datum = 0.9252 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.031,0.518,0.064,0.016,0.017,0.656,0,0,0,0,0.119,0.017,0.292,0.02,0.161,0.043,0.008,0.002,0.013,0.213,0,0,0.015,0.005,0.016,0.02,0.011,0,0,0,0,0,0.027,0,0,0,0};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {240.9,226.3,55.6,53.4,250.3,58.2,0,0,0,0,49.6,48.8,214,259.3,223.7,204.3,201.8,64.4,217.1,64.1,0,0,79.2,60.9,23,57.4,208.7,0,0,0,0,0,32.8,0,0,0,0};
