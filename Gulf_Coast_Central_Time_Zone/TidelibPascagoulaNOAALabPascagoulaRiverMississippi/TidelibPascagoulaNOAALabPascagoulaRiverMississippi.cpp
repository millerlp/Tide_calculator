/*  TidelibPascagoulaNOAALabPascagoulaRiverMississippi.cpp 
...
#include "TidelibPascagoulaNOAALabPascagoulaRiverMississippi.h"
...
// Selected station: Pascagoula NOAA Lab, Pascagoula River, Mississippi
char stationID[] = "Pascagoula NOAA Lab, Pascagoula River, Mississippi";
// Selection station ID number: 8741533
const long stationIDnumber = 8741533;
...
const float Datum = 0.7513 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.03,0.501,0.025,0.003,0.019,0.093,0.003,0.022,0.003,0.001,0.02,0.008,0.471,0.023,0.146,0.101,0.018,0.001,0.028,0.061,0.009,0,0.006,0.003,0.004,0.002,0.021,0.01,0.008,0.011,0.008,0.001,0,0,0,0.377,0.19};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {50.7,37.1,144.7,181.6,64.3,145.6,292.9,92,202.9,195.1,183.6,191.3,29.5,41.4,32.8,17.4,6.2,74,150.4,167.2,211.7,0,112,90.6,128.8,184.8,12.6,108,92.1,42.1,114.4,8.2,0,0,0,141.3,40};
