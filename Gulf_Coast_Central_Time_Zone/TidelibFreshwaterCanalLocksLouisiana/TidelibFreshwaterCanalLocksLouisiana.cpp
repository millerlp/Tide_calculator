/*  TidelibFreshwaterCanalLocksLouisiana.cpp 
...
#include "TidelibFreshwaterCanalLocksLouisiana.h"
...
// Selected station: Freshwater Canal Locks, Louisiana
char stationID[] = "Freshwater Canal Locks, Louisiana";
// Selection station ID number: 8766072
const long stationIDnumber = 8766072;
...
const float Datum = 1.2369 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.036,0.545,0.013,0.007,0.026,0.43,0.013,0.016,0.007,0.003,0.118,0.02,0.492,0.02,0.167,0.105,0.013,0.01,0.013,0.144,0.007,0.003,0.013,0.01,0.016,0.026,0.016,0,0.01,0.01,0.003,0.007,0,0,0,0.328,0.207};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {26.3,22.7,261.5,312.8,50.5,245.9,190.1,34.5,300.9,108,223.2,208.5,15.9,43.6,14,1.1,352.3,355,266,236.4,223.1,264.5,253.2,25.7,177.9,238.4,6.6,0,159.1,356.8,11.2,299.3,0,0,0,148.3,54.7};
