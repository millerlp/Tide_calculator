/*  TidelibCalcasieuPassEastJettyLouisiana.cpp 
...
#include "TidelibCalcasieuPassEastJettyLouisiana.h"
...
// Selected station: Calcasieu Pass, East Jetty, Louisiana
char stationID[] = "Calcasieu Pass, East Jetty, Louisiana";
// Selection station ID number: 8768094
const long stationIDnumber = 8768094;
...
const float Datum = 1.1909 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.026,0.476,0.026,0.01,0.023,0.446,0.01,0.03,0.007,0,0.118,0.016,0.433,0.023,0.141,0.095,0.016,0.003,0.02,0.131,0.003,0.003,0.01,0.007,0.016,0.023,0.013,0.03,0.03,0.013,0.013,0.007,0,0,0,0.361,0.243};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {39.9,31.6,313.4,310.6,52.7,254.4,209.5,343.1,259.8,0,233.8,198.6,26.4,57.6,25.6,7.8,12,325.2,281.2,249.7,65.3,272.6,291.8,31.5,201,243.6,12.4,96.3,102.7,319.6,351,317.9,0,0,0,143.9,67.5};
