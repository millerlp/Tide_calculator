/*  TidelibGulfportGulfportHarborMississippi.cpp 
...
#include "TidelibGulfportGulfportHarborMississippi.h"
...
// Selected station: Gulfport, Gulfport Harbor, Mississippi
char stationID[] = "Gulfport, Gulfport Harbor, Mississippi";
// Selection station ID number: 8745557
const long stationIDnumber = 8745557;
...
const float Datum = 0.876 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.031,0.565,0.029,0.006,0.021,0.119,0.002,0.029,0.003,0,0.027,0.011,0.524,0.03,0.145,0.119,0.021,0.002,0.05,0.092,0.007,0,0.008,0.002,0.007,0.004,0.023,0.01,0.01,0.012,0.012,0.004,0,0,0,0.259,0.194};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {54.3,39.9,163.8,185.8,55.7,168.8,308.8,139.5,248.2,0,199.3,185.9,30.7,37.9,40.5,17,352,123.6,133.2,187.6,262,0,73.1,103.7,161.4,259.3,9.7,138.6,108.6,93.1,167.4,3.4,0,0,0,139.3,57};
