/*  TidelibRealitosPeninsulaTexas.cpp 
...
#include "TidelibRealitosPeninsulaTexas.h"
...
// Selected station: Realitos Peninsula, Texas
char stationID[] = "Realitos Peninsula, Texas";
// Selection station ID number: 8779280
const long stationIDnumber = 8779280;
...
const float Datum = 0.31 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.01,0.18,0.016,0.003,0.01,0.033,0.003,0.003,0,0,0.007,0.007,0.164,0.013,0.043,0.036,0.013,0.003,0.02,0.007,0.003,0,0.007,0,0.003,0.003,0.013,0.003,0.007,0,0,0,0,0,0,0.18,0.226};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {160.2,123.8,50,39.4,207.8,53.4,217.6,309.8,0,0,24.2,198.9,112.9,174.2,116.8,92.2,287.6,148.9,147.7,81.8,191.7,0,257.6,0,232.7,50.8,92.2,61.1,37.8,0,0,0,0,0,0,196.1,58.8};
