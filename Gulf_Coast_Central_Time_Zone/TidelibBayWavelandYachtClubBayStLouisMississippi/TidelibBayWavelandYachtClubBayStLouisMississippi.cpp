/*  TidelibBayWavelandYachtClubBayStLouisMississippi.cpp 
...
#include "TidelibBayWavelandYachtClubBayStLouisMississippi.h"
...
const int adjustGMT = 6;     // Time zone adjustment to get time in GMT.
...
// Selected station: Bay Waveland Yacht Club, Bay St. Louis, Mississippi
char stationID[] = "Bay Waveland Yacht Club, Bay St. Louis, Mississippi";
// Selection station ID number: 8747437
const long stationIDnumber = 8747437;
...
const float Datum = 0.8727 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.03,0.555,0.04,0.006,0.02,0.099,0.003,0.023,0.003,0,0.023,0.009,0.506,0.039,0.137,0.104,0.019,0.008,0.046,0.084,0.007,0.001,0.009,0.002,0.005,0.003,0.022,0.024,0.022,0.015,0.007,0.003,0,0,0,0.435,0.262};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {82.6,58.5,202.3,206.1,105.7,205.7,2,223.7,43,0,238.4,246.2,48.8,55.6,60.8,37.6,8.9,241.2,137,216.1,343.6,120.3,111.2,164.7,153.7,308.7,28.6,209.4,193.2,165.9,275.4,57.1,0,0,0,138.5,40.7};
