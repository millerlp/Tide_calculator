/*  TidelibShellBeachLakeBorgneLouisiana.cpp 
...
#include "TidelibShellBeachLakeBorgneLouisiana.h"
...
// Selected station: Shell Beach, Lake Borgne, Louisiana
char stationID[] = "Shell Beach, Lake Borgne, Louisiana";
// Selection station ID number: 8761305
const long stationIDnumber = 8761305;
...
const prog_float_t Amp[] PROGMEM = {0.02,0.463,0.052,0.007,0.016,0.082,0,0.01,0,0,0.02,0.003,0.427,0.046,0.135,0.089,0.007,0.01,0.039,0.052,0.003,0.003,0,0.007,0.003,0.003,0.023,0.02,0.02,0.007,0,0.007,0.026,0.03,0.039,0.325,0.285};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {103.4,96.5,298.8,305.6,147.5,293.1,0,354.7,0,0,325.7,214.9,83.3,97.4,96.9,67.9,34,268.3,72.4,315,166,238.3,0,271.9,143.4,336.7,66.5,11.5,355.7,313.7,0,137.5,277.2,32.6,340.9,167.5,63.4};
