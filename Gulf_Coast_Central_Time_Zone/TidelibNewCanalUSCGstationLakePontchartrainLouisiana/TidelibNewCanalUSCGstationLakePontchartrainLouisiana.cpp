/*  TidelibNewCanalUSCGstationLakePontchartrainLouisiana.cpp 
...
#include "TidelibNewCanalUSCGstationLakePontchartrainLouisiana.h"
...
// Selected station: New Canal USCG station, Lake Pontchartrain, Louisiana
char stationID[] = "New Canal USCG station, Lake Pontchartrain, Louisiana";
// Selection station ID number: 8761927
const long stationIDnumber = 8761927;
...
const float Datum = 0.2461 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0,0.121,0.006,0.001,0.006,0.009,0,0.001,0,0.001,0,0,0.117,0.014,0.025,0.022,0,0.002,0.015,0.006,0.004,0,0.002,0,0.001,0,0.007,0.002,0,0,0,0,0,0,0,0.332,0.249};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {0,190.5,72.1,0,263.1,49.6,0,0,0,0,0,0,176.4,199.7,190.6,156.9,0,0,147.8,327.1,207.2,0,260.4,0,0,0,135.4,219.2,0,0,0,0,0,0,0,147.4,44.9};
