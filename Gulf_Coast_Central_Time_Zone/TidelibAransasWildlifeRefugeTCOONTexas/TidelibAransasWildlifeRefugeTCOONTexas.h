/*  TidelibAransasWildlifeRefugeTCOONTexas.h 
  A library for calculating the current tide height at 
   Aransas Wildlife Refuge (TCOON), Texas , NOAA station ID number  8774230 
...
#ifndef  TidelibAransasWildlifeRefugeTCOONTexas_h 
#define  TidelibAransasWildlifeRefugeTCOONTexas_h 
#include <Arduino.h>
