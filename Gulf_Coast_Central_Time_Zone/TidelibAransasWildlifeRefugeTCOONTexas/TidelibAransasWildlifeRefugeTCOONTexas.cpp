/*  TidelibAransasWildlifeRefugeTCOONTexas.cpp 
...
#include "TidelibAransasWildlifeRefugeTCOONTexas.h"
...
// Selected station: Aransas Wildlife Refuge (TCOON), Texas
char stationID[] = "Aransas Wildlife Refuge (TCOON), Texas";
// Selection station ID number: 8774230
const long stationIDnumber = 8774230;
...
const float Datum = 0.15 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.003,0.069,0.003,0.003,0.003,0.007,0,0,0,0,0,0.003,0.059,0.013,0.026,0.013,0.007,0.003,0.016,0.01,0.003,0,0.003,0,0.003,0.003,0.003,0.003,0,0,0,0,0,0,0,0.256,0.338};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {246.2,183.8,91.5,199.1,341.3,87.9,0,0,0,0,0,221,166.6,217.8,176.9,129.8,340.8,305.3,99.7,15.4,277.8,0,115,0,140.8,28.8,76.3,226.5,0,0,0,0,0,0,0,166.9,54.4};
