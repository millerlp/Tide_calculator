/*  TidelibCoastGuardStationSouthPadreIslandTexas.cpp 
...
#include "TidelibCoastGuardStationSouthPadreIslandTexas.h"
...
// Selected station: Coast Guard Station, South Padre Island, Texas
char stationID[] = "Coast Guard Station, South Padre Island, Texas";
// Selection station ID number: 8779748
const long stationIDnumber = 8779748;
...
const float Datum = 0.81 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.023,0.423,0.023,0.003,0.007,0.187,0.007,0.003,0,0,0.049,0.003,0.433,0.023,0.128,0.105,0.013,0.003,0.02,0.046,0.003,0,0.007,0,0.007,0.01,0.026,0.01,0.013,0.003,0.003,0,0,0,0,0.217,0.262};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {55.3,34.8,320.3,316.9,99.3,266.7,74.1,106.6,0,0,247,153,28.8,55.8,37.3,12.2,0.7,240.4,322.8,273.3,243.4,0,279.4,0,186.6,249.8,25.8,77.6,69.6,61.5,107.1,0,0,0,0,186.1,49.6};
