/*  TidelibTexasPointSabinePassTexas.cpp 
...
#include "TidelibTexasPointSabinePassTexas.h"
...
// Selected station: Texas Point, Sabine Pass, Texas
char stationID[] = "Texas Point, Sabine Pass, Texas";
// Selection station ID number: 8770822
const long stationIDnumber = 8770822;
...
const float Datum = 1.16 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.03,0.469,0.049,0.013,0.013,0.436,0.013,0.016,0.003,0.003,0.108,0.023,0.423,0.033,0.157,0.075,0.003,0.033,0.013,0.125,0.003,0.003,0.033,0.003,0.023,0.023,0.01,0.023,0.026,0.007,0.013,0.003,0,0,0,0.213,0.253};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {34.1,35,317.3,76,68.3,266.4,194.9,326.6,300.2,182.3,246.7,183,28.3,44.5,30.6,10,255.5,69.7,231,270.4,193.9,191.1,256.5,319.6,178.4,233.7,16.8,121.7,129.9,306,334.1,2.9,0,0,0,135.7,52};
