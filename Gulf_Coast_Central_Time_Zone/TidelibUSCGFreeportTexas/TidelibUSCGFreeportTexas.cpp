...
#include "TidelibUSCGFreeportTexas.h"
...
// Selected station: USCG Freeport, Texas
char stationID[] = "USCG Freeport, Texas";
// Selection station ID number: 8772447
const long stationIDnumber = 8772447;
...
const prog_float_t Amp[] PROGMEM = {0.023,0.502,0.02,0.016,0.016,0.312,0.01,0.013,0.003,0.003,0.082,0.013,0.476,0.016,0.151,0.118,0.023,0.007,0.033,0.089,0.003,0,0.003,0.003,0.01,0.016,0.02,0.003,0.007,0.007,0.01,0.007,0,0,0,0.187,0.243};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {46.3,26.5,276.8,326.9,42.8,275.3,38,162.4,257.3,12.5,252.1,194.1,18.1,41.9,25.9,2.2,339.9,271.9,309.2,276,277.7,0,309,358.6,180.1,238.1,355.6,7.7,359.2,137.3,152,341.6,0,0,0,173.5,64.3};
