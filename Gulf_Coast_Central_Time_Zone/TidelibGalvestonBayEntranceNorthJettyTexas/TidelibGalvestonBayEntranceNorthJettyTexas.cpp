/*  TidelibGalvestonBayEntranceNorthJettyTexas.cpp 
...
#include "TidelibGalvestonBayEntranceNorthJettyTexas.h"
...
// Selected station: Galveston Bay Entrance, North Jetty, Texas
char stationID[] = "Galveston Bay Entrance, North Jetty, Texas";
// Selection station ID number: 8771341
const long stationIDnumber = 8771341;
...
const float Datum = 0.97 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.03,0.482,0.02,0.01,0.02,0.361,0,0.01,0.007,0,0.092,0.013,0.456,0.016,0.138,0.098,0.016,0.007,0.036,0.098,0.007,0.003,0.013,0.003,0.013,0.02,0.02,0.013,0.01,0.007,0.003,0.007,0,0,0,0.246,0.272};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {30.7,40.8,344.2,330.6,67.3,281.5,0,232.7,278.9,0,257.4,244.1,33.1,85.1,35.8,14.6,3.2,133.4,320.2,289,210.2,264.4,269.2,3.5,218.4,271.3,21.7,107.4,96.3,193.1,267.2,348.2,0,0,0,154.9,76};
