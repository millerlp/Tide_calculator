/*  TidelibGrandIsleMississippiRiverDeltaLouisiana2.cpp 
...
#include "TidelibGrandIsleMississippiRiverDeltaLouisiana2.h"
...
// Selected station: Grand Isle, Mississippi River Delta, Louisiana (2)
char stationID[] = "Grand Isle, Mississippi River Delta, Louisiana (2)";
// Selection station ID number: 8761724
const long stationIDnumber = 8761724;
...
const float Datum = 0.54 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.02,0.374,0.007,0.003,0.016,0.043,0,0,0,0,0.016,0.003,0.374,0.02,0.118,0.082,0.01,0,0.016,0.023,0,0,0,0,0,0.003,0.016,0,0,0,0,0,0,0,0,0.285,0.197};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {41.2,37.4,153.8,149.8,42.1,163,0,0,0,0,176.1,189.1,30.8,33.5,37.2,19.2,3.6,0,4.6,154.6,0,0,0,0,0,174.2,17.3,0,0,0,0,0,0,0,0,149.7,49.7};
