/*  TidelibDauphinIslandMobileBayAlabama.cpp 
...
#include "TidelibDauphinIslandMobileBayAlabama.h"
...
// Selected station: Dauphin Island, Mobile Bay, Alabama
char stationID[] = "Dauphin Island, Mobile Bay, Alabama";
// Selection station ID number: 8735180
const long stationIDnumber = 8735180;
...
const float Datum = 0.5643 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.02,0.463,0.016,0,0.03,0.049,0,0,0,0,0,0,0.453,0.036,0.141,0.098,0.01,0,0.013,0.023,0,0,0,0,0,0,0.016,0,0,0,0,0,0,0,0,0.262,0.164};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {65.9,50.6,222.8,0,99.5,132.5,0,0,0,0,0,0,41.9,56.4,49.9,26.6,46.2,0,290,117.3,0,0,0,0,0,0,15.7,0,0,0,0,0,0,0,0,156.3,51.3};
