/*  TidelibLameshurBayStJohnVirginIslands.cpp 
...
#include "TidelibLameshurBayStJohnVirginIslands.h"
...
// Selected station: Lameshur Bay, St. John, Virgin Islands
char stationID[] = "Lameshur Bay, St. John, Virgin Islands";
// Selection station ID number: 9751381
const long stationIDnumber = 9751381;
...
const float Datum = 0.3871 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.018,0.272,0.008,0.006,0.011,0.153,0.004,0.004,0.002,0,0.033,0.005,0.195,0.012,0.085,0.034,0.004,0.002,0.006,0.028,0.003,0,0.001,0.003,0.004,0.008,0.007,0.003,0.001,0.003,0.003,0.001,0.049,0.006,0.021,0.196,0.046};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {230.4,228.9,16.7,38.3,242.1,23.8,35.1,298.5,327.5,0,11.4,4.5,222,235.5,230.8,210.4,206,195.5,165.5,22.8,133.3,0,71.1,23.1,63.4,5.2,216.6,193.6,108,183.3,6.3,18.3,358.6,266.2,324.3,191.6,53.2};
