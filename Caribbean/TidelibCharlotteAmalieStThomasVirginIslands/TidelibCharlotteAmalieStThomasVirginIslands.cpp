/*  TidelibCharlotteAmalieStThomasVirginIslands.cpp 
...
#include "TidelibCharlotteAmalieStThomasVirginIslands.h"
...
// Selected station: Charlotte Amalie, St. Thomas, Virgin Islands
char stationID[] = "Charlotte Amalie, St. Thomas, Virgin Islands";
// Selection station ID number: 9751639
const long stationIDnumber = 9751639;
...
const float Datum = 0.374 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.018,0.264,0.009,0.005,0.012,0.135,0.003,0.007,0,0.001,0.029,0.005,0.198,0.012,0.079,0.035,0.005,0.002,0.008,0.029,0.003,0.001,0.003,0.003,0.005,0.007,0.007,0.002,0.001,0.002,0.003,0.001,0.047,0,0,0.21,0.052};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {235.1,229.5,5,41.6,240.8,23.1,38.6,302,0,167.7,13.7,9.1,221.6,236.2,231.2,208.8,196.8,230.4,201.1,9.9,106.3,72.6,306.1,27.3,80.8,6.6,214.8,179.6,180.2,203.6,3.2,26.1,358.7,0,0,181.2,46};
