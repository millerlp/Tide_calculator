/*  TidelibEsperanzaViequesIslandPuertoRico.cpp 
...
#include "TidelibEsperanzaViequesIslandPuertoRico.h"
...
// Selected station: Esperanza, Vieques Island, Puerto Rico
char stationID[] = "Esperanza, Vieques Island, Puerto Rico";
// Selection station ID number: 9752695
const long stationIDnumber = 9752695;
...
const float Datum = 0.39 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.02,0.269,0.01,0.007,0.01,0.092,0.003,0.007,0,0,0.013,0,0.207,0.013,0.082,0.036,0.007,0,0.016,0.03,0,0,0,0.003,0.003,0.003,0.007,0,0,0.007,0.003,0.003,0.052,0,0.023,0.18,0};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {233.6,232.8,5.7,5.9,255.1,343,34.7,250,0,0,307.6,0,226.1,244.5,232.6,212.1,203,0,234.9,9.2,0,0,0,14.7,166.4,352.7,221.6,0,0,151.1,349.4,9.3,0.2,0,340.2,179,0};
