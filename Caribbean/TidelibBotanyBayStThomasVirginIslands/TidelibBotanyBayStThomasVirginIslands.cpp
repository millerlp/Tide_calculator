/*  TidelibBotanyBayStThomasVirginIslands.cpp 
...
#include "TidelibBotanyBayStThomasVirginIslands.h"
...
// Selected station: Botany Bay, St. Thomas, Virgin Islands
char stationID[] = "Botany Bay, St. Thomas, Virgin Islands";
// Selection station ID number: 9751774
const long stationIDnumber = 9751774;
...
const float Datum = 0.5873 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.02,0.22,0.023,0.023,0.01,0.413,0,0.007,0,0,0.098,0.007,0.187,0.013,0.056,0.033,0.003,0.079,0.043,0.151,0,0,0.049,0.01,0.01,0.023,0.007,0.003,0,0,0,0.003,0,0,0,0.2,0.062};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {218,216.1,329.6,328.7,212.7,15.9,0,358.9,0,0,359.7,3.8,216,234.4,220.2,198.5,128.3,256.4,207.5,73.2,0,0,96.8,333.5,35.5,5.9,186.2,65.9,0,0,0,139,0,0,0,181.8,47.2};
