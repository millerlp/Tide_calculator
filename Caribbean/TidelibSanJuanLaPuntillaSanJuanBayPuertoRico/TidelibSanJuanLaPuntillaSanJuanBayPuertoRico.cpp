/*  TidelibSanJuanLaPuntillaSanJuanBayPuertoRico.cpp 
...
#include "TidelibSanJuanLaPuntillaSanJuanBayPuertoRico.h"
...
// Selected station: San Juan, La Puntilla, San Juan Bay, Puerto Rico
char stationID[] = "San Juan, La Puntilla, San Juan Bay, Puerto Rico";
// Selection station ID number: 9755371
const long stationIDnumber = 9755371;
...
const float Datum = 0.76 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.016,0.285,0.023,0.01,0.013,0.505,0.003,0.007,0.003,0.003,0.121,0.016,0.249,0.013,0.092,0.049,0.007,0,0.016,0.066,0.003,0,0.01,0.007,0.016,0.023,0.01,0.007,0.007,0.003,0.003,0.003,0.003,0,0.02,0.18,0.049};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {214,227.7,49.6,21.3,266.1,20.3,46.2,250.9,358.8,172.6,358.3,337.3,226.4,252.2,228.9,211.2,218.6,0,153,49.4,189.1,0,24.9,41.8,18.8,1.5,214.9,35.4,24.5,191,348.5,20.1,350.1,0,354.5,181.4,38.3};
