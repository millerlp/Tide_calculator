...
#include "TidelibFajardoPuertoRico.h"
...
// Selected station: Fajardo, Puerto Rico
char stationID[] = "Fajardo, Puerto Rico";
// Selection station ID number: 9753216
const long stationIDnumber = 9753216;
...
const float Datum = 0.73 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.016,0.242,0.02,0.022,0.013,0.516,0.002,0.001,0.003,0.001,0.126,0.016,0.192,0.012,0.074,0.036,0.003,0.001,0.016,0.077,0.001,0,0.008,0.007,0.016,0.022,0.01,0.004,0.003,0,0.002,0.002,0.055,0.009,0.031,0.112,0.006};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {226.1,219.2,39.4,38.5,230.8,12.5,321.7,280.2,342.9,206.8,345.2,338,222.8,223.5,220.1,212.9,241.5,342.4,224.4,41.2,252.8,0,18.3,46.9,10.9,342.6,208.4,19.9,325.5,0,22,39.1,357.2,298.4,318.4,197.4,258.8};
