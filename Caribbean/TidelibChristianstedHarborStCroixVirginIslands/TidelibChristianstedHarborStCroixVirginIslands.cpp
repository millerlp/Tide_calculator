/*  TidelibChristianstedHarborStCroixVirginIslands.cpp 
...
#include "TidelibChristianstedHarborStCroixVirginIslands.h"
...
// Selected station: Christiansted Harbor, St. Croix, Virgin Islands
char stationID[] = "Christiansted Harbor, St. Croix, Virgin Islands";
// Selection station ID number: 9751364
const long stationIDnumber = 9751364;
...
const float Datum = 0.37 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.016,0.269,0.01,0.007,0.01,0.102,0.003,0.007,0,0,0.013,0.003,0.197,0.013,0.082,0.033,0.003,0.003,0.01,0.033,0.003,0,0.003,0.003,0.003,0.003,0.007,0.003,0,0.003,0.003,0,0.052,0,0.023,0.18,0};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {229.9,228.5,16,359.8,239.5,344.6,47.2,263.1,0,0,310.6,225.7,222.2,234.1,229,209.3,197.5,133.5,242.5,19.7,133.2,0,358.8,330.9,46.5,297.3,219.7,185.6,0,149.5,349.4,0,0.1,0,322.1,179.8,0};
