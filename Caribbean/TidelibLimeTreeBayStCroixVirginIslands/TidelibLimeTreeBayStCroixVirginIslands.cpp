/*  TidelibLimeTreeBayStCroixVirginIslands.cpp 
...
#include "TidelibLimeTreeBayStCroixVirginIslands.h"
...
// Selected station: Lime Tree Bay, St. Croix, Virgin Islands
char stationID[] = "Lime Tree Bay, St. Croix, Virgin Islands";
// Selection station ID number: 9751401
const long stationIDnumber = 9751401;
...
const prog_float_t Amp[] PROGMEM = {0.016,0.276,0.007,0.003,0.013,0.046,0.003,0.007,0,0,0.01,0.003,0.21,0.013,0.085,0.033,0.003,0.003,0.016,0.026,0,0,0.007,0.003,0.003,0,0.01,0.003,0,0.003,0.007,0,0.052,0,0.026,0.213,0};
// Kappa is the 'modified' or 'adapted' phase lag (Epoch) of each of the 
// harmonic constituents for this site.
const prog_float_t Kappa[] PROGMEM = {234.3,237,355.4,31.3,273.5,328.9,27.2,290.7,0,0,232.2,137.2,228.6,248.4,236.1,210.6,204.4,214.4,240.7,11.7,0,0,192.5,350.1,153.8,0,213.6,99.6,0,190,355.2,0,356.9,0,349,173.7,0};
