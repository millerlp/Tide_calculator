...
const float Datum = 2.7329 ; // units in feet
...
const prog_float_t Amp[] PROGMEM = {0.066,1.102,0.194,0.046,0.039,1.64,0,0,0,0,0.387,0.049,0.705,0.039,0.348,0.131,0.016,0.007,0.02,0.669,0,0,0.039,0.01,0.052,0.075,0.026,0,0,0,0,0,0,0,0,0.23,0.056};
const prog_float_t Kappa[] PROGMEM = {215.7,206.7,132.8,163.5,221.6,141.7,0,0,0,0,120.1,90.8,191.2,234.2,202.3,182.5,175.7,136.7,296.5,136.7,0,0,121.1,139.4,84.3,123.9,184.5,0,0,0,0,0,0,0,0,184.3,263.2};
