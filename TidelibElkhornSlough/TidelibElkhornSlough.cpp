...
#include "RTClib.h"
#include "TidelibElkhornSlough.h"
...
// Selected station:  Elkhorn Slough railroad bridge, Monterey Bay, California 
char stationID[] = " Elkhorn Slough railroad bridge, Monterey Bay, California ";
...
const float Datum = 2.9298 ; // units in feet
...
PROGMEM prog_float_t Amp[] = {0.069,1.142,0.125,0.039,0.062,1.713,0.036,0.082,0.013,0.01,0.381,0.046,0.712,0.056,0.361,0.121,0.013,0.016,0.043,0.44,0.007,0.003,0.03,0.026,0.016,0.062,0.016,0.082,0.082,0.039,0.052,0.013,0.039,0.043,0.043,0.531,0.161};
PROGMEM prog_float_t Kappa[] = {261.1,229.4,176.5,174.4,266,192,35.8,129.7,122.7,55.7,170.5,158.7,215,275.3,227.6,212.9,208.5,238.4,267.6,197.2,181.3,133.2,157.9,135.7,220.3,173.4,226,203.5,211.8,113.9,138.1,310.9,250.9,34.4,65.6,217.5,156.5};
